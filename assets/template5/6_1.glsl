...
void main() {
    ...
    if (textureCoordinate.x <= (1./3.) && textureCoordinate.y <= (1./3.)) {
        uv -= 0.5;
        uv = (uv / scale) + 0.5;
    ...
    } else if (textureCoordinate.x > (1./3.) && textureCoordinate.x <= (2./3.) && textureCoordinate.y <= (1./3.)) {
        uv2 -= 0.5;
        uv2 = (uv2 / scale) + 0.5;
    ...
    } else if (textureCoordinate.x > (2./3.) && textureCoordinate.y <= (1./3.)) {
        uv3 -= 0.5;
        uv3 = (uv3 / scale) + 0.5;
    ...
    } else if (textureCoordinate.x <= (1./3.) && textureCoordinate.y > (1./3.) && textureCoordinate.y <= (2./3.)) {
        uv4 -= 0.5;
        uv4 = (uv4 / scale) + 0.5;
    ...
    } else if (textureCoordinate.x > (1./3.) && textureCoordinate.x <= (2./3.) && textureCoordinate.y > (1./3.) && textureCoordinate.y <= (2./3.)) {
        uv5 -= 0.5;
        uv5 = (uv5 / scale) + 0.5;
