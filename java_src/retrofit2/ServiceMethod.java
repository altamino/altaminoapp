...
final class ServiceMethod<R, T> {
    ...
    Request toRequest(Object... objArr) throws IOException {
    ...
    static final class Builder<T, R> {
        ...
        private void parseMethodAnnotation(Annotation annotation) {
            ...
            if (annotation instanceof POST) {
                parseHttpMethodAndPath(GlobalSearchResultSection.SECTION_TYPE_POST, ((POST) annotation).value(), true);
                return;
            }
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            ...
            if (annotation instanceof Field) {
                ...
                if (rawType5.isArray()) {
                    return new ParameterHandler.Field(strValue4, this.retrofit.stringConverter(ServiceMethod.boxIfPrimitive(rawType5.getComponentType()), annotationArr), zEncoded3).array();
                }
            ...
            if (annotation instanceof FieldMap) {
                ...
                Converter<T, String> converterStringConverter = this.retrofit.stringConverter(Utils.getParameterUpperBound(1, parameterizedType2), annotationArr);
                this.gotField = true;
            ...
            if (annotation instanceof Part) {
                ...
                if (Iterable.class.isAssignableFrom(rawType7)) {
                    ...
                    return new ParameterHandler.Part(headersOf, this.retrofit.requestBodyConverter(parameterUpperBound3, annotationArr, this.methodAnnotations)).iterable();
                }
                if (rawType7.isArray()) {
