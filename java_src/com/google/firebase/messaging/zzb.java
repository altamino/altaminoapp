...
public final class zzb {
    ...
    public static boolean zzh(Bundle bundle) {
        return IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE.equals(zza(bundle, "gcm.n.e")) || zza(bundle, "gcm.n.icon") != null;
    }
    ...
    private final int zzl(String str) {
        ...
        return (i == 0 || !zzb(i)) ? R.drawable.sym_def_app_icon : i;
    }
    ...
    private static boolean zzk(Bundle bundle) {
        return bundle != null && IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE.equals(bundle.getString("google.c.a.e"));
    }
}
