...
interface zzgx {
    ...
    <T> T zza(zzgy<T> zzgyVar, zzem zzemVar) throws IOException;

    <T> void zza(List<T> list, zzgy<T> zzgyVar, zzem zzemVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzga<K, V> zzgaVar, zzem zzemVar) throws IOException;

    @Deprecated
    <T> T zzb(zzgy<T> zzgyVar, zzem zzemVar) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzgy<T> zzgyVar, zzem zzemVar) throws IOException;
