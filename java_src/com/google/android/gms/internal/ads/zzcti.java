...
final /* synthetic */ class zzcti implements Callable {
    static final Callable zzghi = new zzcti();
    ...
    public final Object call() {
        ...
        if (((Boolean) zzyt.zzpe().zzd(zzacu.zzcmj)).booleanValue()) {
        ...
        bundle.putInt("web_view_count", com.google.android.gms.ads.internal.zzk.zzlk().zzvb());
