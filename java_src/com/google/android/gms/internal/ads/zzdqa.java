...
interface zzdqa {
    ...
    <T> T zza(zzdqb<T> zzdqbVar, zzdno zzdnoVar) throws IOException;

    <T> void zza(List<T> list, zzdqb<T> zzdqbVar, zzdno zzdnoVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzdpd<K, V> zzdpdVar, zzdno zzdnoVar) throws IOException;
    ...
    @Deprecated
    <T> T zzb(zzdqb<T> zzdqbVar, zzdno zzdnoVar) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzdqb<T> zzdqbVar, zzdno zzdnoVar) throws IOException;
