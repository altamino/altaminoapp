...
interface zzdro {
    ...
    void zza(int i, zzdmr zzdmrVar) throws IOException;

    <K, V> void zza(int i, zzdpd<K, V> zzdpdVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj, zzdqb zzdqbVar) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzdqb zzdqbVar) throws IOException;

    void zza(int i, List<Integer> list, boolean z) throws IOException;

    void zzaa(int i, int i2) throws IOException;

    void zzah(int i, int i2) throws IOException;

    void zzai(int i, int i2) throws IOException;

    int zzawy();

    void zzb(int i, double d) throws IOException;

    void zzb(int i, Object obj) throws IOException;

    @Deprecated
    void zzb(int i, Object obj, zzdqb zzdqbVar) throws IOException;

    void zzb(int i, List<zzdmr> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzdqb zzdqbVar) throws IOException;
    ...
    @Deprecated
    void zzgm(int i) throws IOException;

    @Deprecated
    void zzgn(int i) throws IOException;
    ...
    void zzi(int i, boolean z) throws IOException;
