...
public class zzaxo {
    ...
    public boolean zza(final Context context, final WebSettings webSettings) {
        return ((Boolean) zzazl.zza(context, new Callable(context, webSettings) { // from class: com.google.android.gms.internal.ads.zzaxp
            ...
            public final Object call() {
                ...
                WebSettings webSettings2 = this.zzdwb;
    ...
    public CookieManager zzaz(Context context) {
        ...
        try {
            ...
            zzbad.zzc("Failed to obtain CookieManager.", th);
            com.google.android.gms.ads.internal.zzk.zzlk().zza(th, "ApiLevelUtil.getCookieManager");
            return null;
        }
    }
