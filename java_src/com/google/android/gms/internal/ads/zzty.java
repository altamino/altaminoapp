...
public final class zzty {
    ...
    private final JSONObject zzbsv;
    private final String zzbsw;
    private final String zzbsx;
    private final boolean zzbsy = false;
    private final boolean zzbsz;

    public zzty(String str, zzbai zzbaiVar, String str2, JSONObject jSONObject, boolean z, boolean z2) {
