...
final class zzdre extends zzdrd {
    zzdre() {
    }
        ...
        while (i < i3) {
            ...
            if (zzdrc.zze(b2)) {
                ...
                while (i6 < i3) {
                    ...
                    i6++;
                    zzdrc.zza(b3, cArr, i7);
                    i7++;
                }
                i = i6;
                i5 = i7;
            } else if (zzdrc.zzf(b2)) {
                if (i6 < i3) {
                    zzdrc.zza(b2, bArr[i6], cArr, i5);
                    i = i6 + 1;
                    i5++;
                } else {
                    throw zzdok.zzayk();
                }
            } else if (zzdrc.zzg(b2)) {
                if (i6 < i3 - 1) {
                    int i8 = i6 + 1;
                    zzdrc.zza(b2, bArr[i6], bArr[i8], cArr, i5);
                    i = i8 + 1;
                    i5++;
                } else {
                    throw zzdok.zzayk();
                ...
                byte b4 = bArr[i6];
                int i10 = i9 + 1;
                zzdrc.zza(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                i = i10 + 1;
                i5 = i5 + 1 + 1;
            }
        }
        ...
        while (i7 < length) {
            ...
            if (cCharAt2 >= 128 || i8 >= i6) {
                if (cCharAt2 < 2048 && i8 <= i6 - 2) {
                    ...
                    int i14 = i8 + 1;
                    bArr[i8] = (byte) ((cCharAt2 >>> '\f') | FetchService.QUERY_SINGLE);
                    int i15 = i14 + 1;
