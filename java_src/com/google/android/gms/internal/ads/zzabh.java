...
public final class zzabh extends ContentProvider {
    ...
    public final void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        if (bundleZzh != null) {
            try {
                str = (String) bundleZzh.get("com.google.android.gms.ads.APPLICATION_ID");
            } catch (ClassCastException unused) {
                zzbad.zzen("The com.google.android.gms.ads.APPLICATION_ID metadata must have a String value");
                str = null;
            }
            try {
                bool = (Boolean) bundleZzh.get("com.google.android.gms.ads.AD_MANAGER_APP");
        ...
        if (str != null) {
            ...
            zzbad.zzdp(strValueOf.length() != 0 ? "Publisher provided Google AdMob App ID in manifest: ".concat(strValueOf) : new String("Publisher provided Google AdMob App ID in manifest: "));
