    ...
    protected final boolean dispatchTransaction(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        switch (i) {
            case 1:
                ...
                return true;
            case 2:
                Bundle bundlePerformActionWithResponse = performActionWithResponse((Bundle) zzfo.zza(parcel, Bundle.CREATOR));
                parcel2.writeNoException();
                zzfo.zzb(parcel2, bundlePerformActionWithResponse);
                return true;
            case 3:
            ...
            case 11:
                ...
                return true;
            case 12:
                long jGenerateEventId = generateEventId();
                parcel2.writeNoException();
                parcel2.writeLong(jGenerateEventId);
                return true;
            case 13:
