...
abstract class zzdrd {
    ...
    abstract String zzn(byte[] bArr, int i, int i2) throws zzdok;

    final boolean zzl(byte[] bArr, int i, int i2) {
    ...
    static void zzc(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        while (i < length) {
            ...
            if (cCharAt3 < 128) {
                ...
                iPosition = i3 + 1;
                byteBuffer.put(i3, (byte) (((cCharAt3 >>> 6) & 63) | 128));
