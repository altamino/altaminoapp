...
public final class zzyb implements Parcelable.Creator<zzxz> {
    ...
    public final /* synthetic */ zzxz[] newArray(int i) {
        return new zzxz[i];
    }
    ...
    public final /* synthetic */ zzxz createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < iValidateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(header)) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    zzacaVar = (zzaca) SafeParcelReader.createParcelable(parcel, header, zzaca.CREATOR);
                    break;
                case 11:
        ...
        return new zzxz(i, j, bundleCreateBundle, i2, arrayListCreateStringList, z, i3, z2, strCreateString, zzacaVar, location, strCreateString2, bundleCreateBundle2, bundleCreateBundle3, arrayListCreateStringList2, strCreateString3, strCreateString4, z3, zzxtVar, i4, strCreateString5);
    }
}
