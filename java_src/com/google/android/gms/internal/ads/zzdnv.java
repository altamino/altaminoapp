...
public enum zzdnv {
    ...
    private static final zzdnv[] zzhgo;
    ...
    zzdnv(int i, zzdnx zzdnxVar, zzdom zzdomVar) {
        ...
        this.zzhgl = zzdnxVar;
        this.zzhgk = zzdomVar;
        int i3 = zzdnw.zzhgr[zzdnxVar.ordinal()];
        if (i3 == 1 || i3 == 2) {
        ...
        boolean z = false;
        if (zzdnxVar == zzdnx.SCALAR && (i2 = zzdnw.zzhgs[zzdomVar.ordinal()]) != 1 && i2 != 2 && i2 != 3) {
            z = true;
        }
        this.zzhgn = z;
    }
    ...
    static {
        ...
        zzhgo = new zzdnv[zzdnvVarArrValues.length];
        for (zzdnv zzdnvVar : zzdnvVarArrValues) {
            zzhgo[zzdnvVar.id] = zzdnvVar;
        }
    }
}
