...
public final class zzagk extends RemoteCreator<zzaep> {
    ...
    public final zzaem zzb(Context context, FrameLayout frameLayout, FrameLayout frameLayout2) {
        try {
            IBinder iBinderZza = getRemoteCreatorInstance(context).zza(ObjectWrapper.wrap(context), ObjectWrapper.wrap(frameLayout), ObjectWrapper.wrap(frameLayout2), 15000000);
            if (iBinderZza == null) {
                return null;
            }
    ...
    protected final /* synthetic */ zzaep getRemoteCreator(IBinder iBinder) {
        ...
        if (iInterfaceQueryLocalInterface instanceof zzaep) {
            return (zzaep) iInterfaceQueryLocalInterface;
        }
