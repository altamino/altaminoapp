...
public final class zzaqd {
    ...
    @VisibleForTesting
    private static boolean zzdje;

    @VisibleForTesting
    private static boolean zzxs;
    ...
    public final boolean zzl(Context context) {
        synchronized (lock) {
            ...
            try {
                zzm(context);
                boolean zZzap = this.zzdjf.zzap(ObjectWrapper.wrap(context));
                zzxs = zZzap;
                return zZzap;
    ...
    public final String getVersion(Context context) {
        ...
        try {
            zzm(context);
            String strValueOf = String.valueOf(this.zzdjf.getVersion());
    ...
    public final IObjectWrapper zza(String str, WebView webView, String str2, String str3, String str4, String str5) {
        synchronized (lock) {
            try {
                try {
                    if (((Boolean) zzyt.zzpe().zzd(zzacu.zzcuu)).booleanValue() && zzxs) {
                        try {
