...
public final class zzdpe<K, V> extends LinkedHashMap<K, V> {
    private static final zzdpe zzhjl;
    ...
    public final V put(K k, V v) {
        zzayv();
        zzdod.checkNotNull(k);
        zzdod.checkNotNull(v);
    ...
    */
    ...
    private static int zzad(Object obj) {
    ...
    public final int hashCode() {
        ...
        for (Map.Entry<K, V> entry : entrySet()) {
            iZzad += zzad(entry.getValue()) ^ zzad(entry.getKey());
        }
        return iZzad;
    }
