...
public final class zzaba {
    private String zzcgs;
    private String zzcgu;
    ...
    private final Bundle zzcis = new Bundle();
    private final HashMap<Class<? extends NetworkExtras>, NetworkExtras> zzciz = new HashMap<>();
    private final HashSet<String> zzcja = new HashSet<>();
    private final Bundle zzcgw = new Bundle();
