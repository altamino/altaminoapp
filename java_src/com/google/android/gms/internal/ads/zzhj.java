...
public final class zzhj {
    ...
    public static zzhj zzem() {
        return new zzhj(MimeTypes.APPLICATION_TTML, -1, -1L, -1, -1, -1.0f, -1, -1, null);
    }

    @TargetApi(16)
    private zzhj(MediaFormat mediaFormat) {
        this.zzafy = mediaFormat;
        this.mimeType = mediaFormat.getString(IMediaFormat.KEY_MIME);
    ...
    public final int hashCode() {
        if (this.zzafx == 0) {
            ...
            int iHashCode = (((((((((((((((((((str == null ? 0 : str.hashCode()) + 527) * 31) + this.zzafs) * 31) + this.width) * 31) + this.height) * 31) + Float.floatToRawIntBits(this.zzaft)) * 31) + ((int) this.zzack)) * 31) + this.maxWidth) * 31) + this.maxHeight) * 31) + this.zzafu) * 31) + this.zzafv;
            for (int i = 0; i < this.zzafw.size(); i++) {
                iHashCode = (iHashCode * 31) + Arrays.hashCode(this.zzafw.get(i));
            }
            this.zzafx = iHashCode;
        }
        return this.zzafx;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && zzhj.class == obj.getClass()) {
            ...
            if (this.zzafs == zzhjVar.zzafs && this.width == zzhjVar.width && this.height == zzhjVar.height && this.zzaft == zzhjVar.zzaft && this.maxWidth == zzhjVar.maxWidth && this.maxHeight == zzhjVar.maxHeight && this.zzafu == zzhjVar.zzafu && this.zzafv == zzhjVar.zzafv && zzkq.zza(this.mimeType, zzhjVar.mimeType) && this.zzafw.size() == zzhjVar.zzafw.size()) {
                for (int i = 0; i < this.zzafw.size(); i++) {
