...
public abstract class zzacj<T> {
    ...
    public static zzacj<String> zzb(int i, String str) {
        zzacj<String> zzacjVarZza = zza(i, str, (String) null);
        zzyt.zzpd().zzb(zzacjVarZza);
        return zzacjVarZza;
    }

    public static zzacj<String> zzc(int i, String str) {
        zzacj<String> zzacjVarZza = zza(i, str, (String) null);
        zzyt.zzpd().zzc(zzacjVarZza);
        return zzacjVarZza;
    }
    ...
    /* synthetic */ zzacj(int i, String str, Object obj, zzack zzackVar) {
        this(i, str, obj);
    }
}
