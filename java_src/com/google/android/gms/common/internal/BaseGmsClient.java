...
public abstract class BaseGmsClient<T extends IInterface> {
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        if (t == null) {
            printWriter.append(PushNotificationService.NO_GROUP);
        } else {
            printWriter.append((CharSequence) getServiceDescriptor()).append(MentionedEditText.DEFAULT_METION_TAG).append((CharSequence) Integer.toHexString(System.identityHashCode(t.asBinder())));
        }
        printWriter.append(" mServiceBroker=");
        if (iGmsServiceBroker == null) {
            printWriter.println(PushNotificationService.NO_GROUP);
        } else {
