...
public class GooglePlayServicesUtilLight {
    ...
    @VisibleForTesting
    private static int zza(Context context, boolean z, int i) throws PackageManager.NameNotFoundException {
    ...
    public static boolean isRestrictedUserProfile(Context context) {
        ...
        return PlatformVersion.isAtLeastJellyBeanMR2() && (applicationRestrictions = ((UserManager) context.getSystemService(GlobalProfileFragment.KEY_USER)).getApplicationRestrictions(context.getPackageName())) != null && "true".equals(applicationRestrictions.getString("restricted_profile"));
    }
}
