...
public final class Ac4Util {
    ...
    private static final int[] SAMPLE_COUNT = {2002, 2000, 1920, 1601, 1600, 1001, 1000, 960, 800, 800, FetchService.QUERY_SINGLE, WsMessage.LIVE_LAYER_USER_JOINED_EVENT, WsMessage.LIVE_LAYER_USER_JOINED_EVENT, 2048};
    ...
    public static Format parseAc4AnnexEFormat(ParsableByteArray parsableByteArray, String str, String str2, DrmInitData drmInitData) {
        ...
        return Format.createAudioSampleFormat(str, MimeTypes.AUDIO_AC4, null, -1, -1, 2, ((parsableByteArray.readUnsignedByte() & 32) >> 5) == 1 ? MediaRecordManager.ENCODE_BIT_RATE : RtcChatManager.SAMPLE_RATE, null, drmInitData, 0, str2);
    }
