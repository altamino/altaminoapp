...
final class AudioTrackPositionTracker {
    ...
    public long getCurrentPositionUs(boolean z) {
        ...
        if (audioTimestampPoller2.hasTimestamp()) {
            long jFramesToDurationUs = framesToDurationUs(audioTimestampPoller2.getTimestampPositionFrames());
            return !audioTimestampPoller2.isTimestampAdvancing() ? jFramesToDurationUs : jFramesToDurationUs + (jNanoTime - audioTimestampPoller2.getTimestampSystemTimeUs());
        }
    ...
    private void maybeUpdateLatency(long j) {
        ...
        try {
            ...
            this.latencyUs = (r0.intValue() * 1000) - this.bufferSizeUs;
