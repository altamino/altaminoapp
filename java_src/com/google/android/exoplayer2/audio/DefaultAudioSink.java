...
public final class DefaultAudioSink implements AudioSink {
    ...
    public void configure(int i, int i2, int i3, int i4, int[] iArr, int i5, int i6) throws AudioSink.ConfigurationException {
        ...
        int channelConfig = getChannelConfig(outputChannelCount, zIsEncodingLinearPcm);
        if (channelConfig == 0) {
            throw new AudioSink.ConfigurationException("Unsupported channel count: " + outputChannelCount);
        }
        Configuration configuration = new Configuration(zIsEncodingLinearPcm, zIsEncodingLinearPcm ? Util.getPcmFrameSize(i, i2) : -1, i3, zIsEncodingLinearPcm ? Util.getPcmFrameSize(outputEncoding, outputChannelCount) : -1, i7, channelConfig, outputEncoding, i4, z3, z3 && !z4, audioProcessorArr);
        if (!z && this.pendingConfiguration == null) {
            z2 = false;
        }
        if (isInitialized() && (!configuration.canReuseAudioTrack(this.configuration) || z2)) {
    ...
    private void initialize(long j) throws AudioSink.InitializationException {
        ...
        this.audioTrack = configuration.buildAudioTrack(this.tunneling, this.audioAttributes, this.audioSessionId);
