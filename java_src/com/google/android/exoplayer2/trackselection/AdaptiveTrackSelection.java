...
public class AdaptiveTrackSelection extends BaseTrackSelection {
        ...
        public final TrackSelection[] createTrackSelections(TrackSelection.Definition[] definitionArr, BandwidthMeter bandwidthMeter) {
            ...
            for (int i2 = 0; i2 < definitionArr.length; i2++) {
                ...
                if (definition != null) {
                    ...
                    if (iArr.length > 1) {
                        AdaptiveTrackSelection adaptiveTrackSelectionCreateAdaptiveTrackSelection = createAdaptiveTrackSelection(definition.group, bandwidthMeter, iArr);
                        adaptiveTrackSelectionCreateAdaptiveTrackSelection.experimental_setTrackBitrateEstimator(this.trackBitrateEstimator);
                        arrayList.add(adaptiveTrackSelectionCreateAdaptiveTrackSelection);
                        trackSelectionArr[i2] = adaptiveTrackSelectionCreateAdaptiveTrackSelection;
                    } else {
    ...
    public AdaptiveTrackSelection(TrackGroup trackGroup, int[] iArr, BandwidthMeter bandwidthMeter) {
        this(trackGroup, iArr, bandwidthMeter, 10000L, 25000L, 25000L, 0.7f, 0.75f, 2000L, Clock.DEFAULT);
    }
    ...
    public void updateSelectedTrack(long j, long j2, long j3, List<? extends MediaChunk> list, MediaChunkIterator[] mediaChunkIteratorArr) {
        ...
        if (this.reason == 0) {
            this.reason = 1;
            this.selectedIndex = determineIdealSelectedIndex(jElapsedRealtime, this.trackBitrates);
            return;
        }
    ...
    public int evaluateQueueSize(long j, List<? extends MediaChunk> list) {
        ...
        Format format = getFormat(determineIdealSelectedIndex(jElapsedRealtime, this.formatBitrates));
    ...
    private static final class DefaultBandwidthProvider implements BandwidthProvider {
        ...
        public long getAllocatedBandwidth() {
            long jMax = Math.max(0L, ((long) (this.bandwidthMeter.getBitrateEstimate() * this.bandwidthFraction)) - this.nonAllocatableBandwidth);
            ...
            long[] jArr4 = jArr2[i];
            return jArr3[1] + ((long) (((jMax - jArr3[0]) / (jArr4[0] - jArr3[0])) * (jArr4[1] - jArr3[1])));
        }

        void experimental_setNonAllocatableBandwidth(long j) {
    ...
    public static long[][][] getAllocationCheckpoints(long[][] jArr) {
        ...
        long[][][] jArr2 = (long[][][]) Array.newInstance((Class<?>) long.class, logArrayValues.length, iCountArrayElements, 2);
