...
public final class DrmInitData implements Comparator<SchemeData>, Parcelable {
    ...
    DrmInitData(Parcel parcel) {
        ...
        Object[] objArrCreateTypedArray = parcel.createTypedArray(SchemeData.CREATOR);
        Util.castNonNull(objArrCreateTypedArray);
        this.schemeDatas = (SchemeData[]) objArrCreateTypedArray;
