...
public final class Format implements Parcelable {
    ...
    public static Format createVideoContainerFormat(String str, String str2, String str3, String str4, String str5, Metadata metadata, int i, int i2, int i3, float f, List<byte[]> list, int i4, int i5) {
        return new Format(str, str2, i4, i5, i, str5, metadata, str3, str4, -1, list, null, Long.MAX_VALUE, i2, i3, f, -1, -1.0f, null, -1, null, -1, -1, -1, -1, -1, null, -1);
    }
    ...
    */
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            ...
            this.hashCode = ((iHashCode6 + (str6 != null ? str6.hashCode() : 0)) * 31) + this.accessibilityChannel;
        }
