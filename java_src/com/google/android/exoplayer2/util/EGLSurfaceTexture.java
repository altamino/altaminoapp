...
public final class EGLSurfaceTexture implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public void init(int i) {
        ...
        this.context = createEGLContext(this.display, eGLConfigChooseEGLConfig, i);
        this.surface = createEGLSurface(this.display, eGLConfigChooseEGLConfig, this.context, i);
