...
public abstract class BinarySearchSeeker {
    ...
    public interface TimestampSeeker {
        ...
        TimestampSearchResult searchForTimestamp(ExtractorInput extractorInput, long j, OutputFrameHolder outputFrameHolder) throws InterruptedException, IOException;
    }
    ...
    public int handlePendingSeek(ExtractorInput extractorInput, PositionHolder positionHolder, OutputFrameHolder outputFrameHolder) throws InterruptedException, IOException {
        ...
        while (true) {
            ...
            TimestampSearchResult timestampSearchResultSearchForTimestamp = timestampSeeker2.searchForTimestamp(extractorInput, seekOperationParams2.getTargetTimePosition(), outputFrameHolder);
            ...
            if (i == -2) {
                seekOperationParams2.updateSeekFloor(timestampSearchResultSearchForTimestamp.timestampToUpdate, timestampSearchResultSearchForTimestamp.bytePositionToUpdate);
            } else {
                if (i != -1) {
                    if (i == 0) {
                ...
                seekOperationParams2.updateSeekCeiling(timestampSearchResultSearchForTimestamp.timestampToUpdate, timestampSearchResultSearchForTimestamp.bytePositionToUpdate);
            }
        }
    }
    ...
    protected final boolean skipInputUntilPosition(ExtractorInput extractorInput, long j) throws InterruptedException, IOException {
