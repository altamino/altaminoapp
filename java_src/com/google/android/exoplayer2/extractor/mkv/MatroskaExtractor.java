...
public class MatroskaExtractor implements Extractor {
    ...
    */
    protected void binaryElement(int r20, int r21, com.google.android.exoplayer2.extractor.ExtractorInput r22) throws java.lang.InterruptedException, java.io.IOException {
        /*
    ...
    private void writeSampleData(ExtractorInput extractorInput, Track track, int i) throws InterruptedException, IOException {
        ...
        if (CODEC_ID_H264.equals(track.codecId) || CODEC_ID_H265.equals(track.codecId)) {
            ...
            while (this.sampleBytesRead < iLimit) {
                ...
                if (i10 == 0) {
                    readToTarget(extractorInput, bArr3, i9, i8);
    ...
    private static void setSampleDuration(byte[] bArr, long j, String str, int i, long j2, byte[] bArr2) {
        ...
        if (j == C.TIME_UNSET) {
            ...
            long j3 = j - ((r2 * InviteMembersFragment.SECOND_HOUR) * 1000000);
            int i2 = (int) (j3 / 60000000);
            long j4 = j3 - ((i2 * 60) * 1000000);
            int i3 = (int) (j4 / 1000000);
            utf8Bytes = Util.getUtf8Bytes(String.format(Locale.US, str, Integer.valueOf((int) (j / 3600000000L)), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf((int) ((j4 - (i3 * 1000000)) / j2))));
            bArr3 = bArr2;
        }
