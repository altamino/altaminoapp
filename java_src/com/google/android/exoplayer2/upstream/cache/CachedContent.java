...
final class CachedContent {
    ...
    public SimpleCacheSpan setLastTouchTimestamp(SimpleCacheSpan simpleCacheSpan, long j, boolean z) {
        ...
        if (z) {
            cacheFile = SimpleCacheSpan.getCacheFile(file.getParentFile(), this.id, simpleCacheSpan.position, j);
        ...
        SimpleCacheSpan simpleCacheSpanCopyWithFileAndLastTouchTimestamp = simpleCacheSpan.copyWithFileAndLastTouchTimestamp(cacheFile, j);
