...
final class DvbParser {
    ...
    public List<Cue> decode(byte[] bArr, int i) {
        ...
        for (int i4 = 0; i4 < sparseArray2.size(); i4++) {
            ...
            arrayList.add(new Cue(bitmapCreateBitmap, f, 0, i6 / i10, 0, regionComposition.width / i9, regionComposition.height / i10));
    ...
    private static int[] generateDefault8BitClutEntries() {
        ...
        for (int i = 0; i < iArr.length; i++) {
            if (i < 8) {
                ...
                int i2 = i & WsMessage.THREAD_WAIT_LIST_JOIN_CANCEL_REQUEST;
                if (i2 == 0) {
            ...
            if (bits != 240) {
                switch (bits) {
                    case 16:
                        ...
                        parsableBitArray.byteAlign();
                    case 17:
                        iPaint2BitPixelCodeString = paint4BitPixelCodeString(parsableBitArray, iArr, i == 3 ? defaultMap4To8 : null, i4, i5, paint, canvas);
                        parsableBitArray.byteAlign();
                        break;
                    case 18:
