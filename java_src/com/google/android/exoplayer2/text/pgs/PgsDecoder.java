    ...
    private static final class CueBuilder {
        ...
        public Cue build() {
            ...
            while (i < iArr.length) {
                ...
                if (unsignedByte2 != 0) {
                    unsignedByte = i + 1;
                    iArr[i] = this.colors[unsignedByte2];
                } else {
                    int unsignedByte3 = this.bitmapData.readUnsignedByte();
                    if (unsignedByte3 != 0) {
                        unsignedByte = ((unsignedByte3 & 64) == 0 ? unsignedByte3 & 63 : ((unsignedByte3 & 63) << 8) | this.bitmapData.readUnsignedByte()) + i;
                        Arrays.fill(iArr, i, unsignedByte, (unsignedByte3 & 128) == 0 ? 0 : this.colors[this.bitmapData.readUnsignedByte()]);
                    }
                }
                i = unsignedByte;
            }
