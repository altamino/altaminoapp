...
public final class DefaultDownloadIndex implements WritableDownloadIndex {
    ...
    public static Download getDownloadForCurrentRow(Cursor cursor) {
        ...
        return new Download(downloadRequest, cursor.getInt(6), cursor.getLong(7), cursor.getLong(8), cursor.getLong(9), cursor.getInt(10), cursor.getInt(11), downloadProgress);
    }
