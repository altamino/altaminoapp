...
public final class DownloaderConstructorHelper {
    ...
    public DownloaderConstructorHelper(Cache cache, DataSource.Factory factory, DataSource.Factory factory2, DataSink.Factory factory3, PriorityTaskManager priorityTaskManager, CacheKeyFactory cacheKeyFactory) {
        ...
        this.onlineCacheDataSourceFactory = new CacheDataSourceFactory(cache, priorityDataSourceFactory, fileDataSourceFactory, factory3 == null ? new CacheDataSinkFactory(cache, CacheDataSink.DEFAULT_FRAGMENT_SIZE) : factory3, 1, null, cacheKeyFactory);
        this.offlineCacheDataSourceFactory = new CacheDataSourceFactory(cache, DummyDataSource.FACTORY, fileDataSourceFactory, null, 1, null, cacheKeyFactory);
        this.cache = cache;
