...
public final class DownloadRequest implements Parcelable {
    ...
    public DownloadRequest copyWithMergedRequest(DownloadRequest downloadRequest) {
        ...
        return new DownloadRequest(this.id, this.type, downloadRequest.uri, listEmptyList, downloadRequest.customCacheKey, downloadRequest.data);
    }
    ...
    public final int hashCode() {
        int iHashCode = ((((((((this.type.hashCode() * 31) + this.id.hashCode()) * 31) + this.type.hashCode()) * 31) + this.uri.hashCode()) * 31) + this.streamKeys.hashCode()) * 31;
