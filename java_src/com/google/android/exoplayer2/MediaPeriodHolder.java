...
final class MediaPeriodHolder {
    ...
    public void handlePrepared(float f, Timeline timeline) throws ExoPlaybackException {
        ...
        Assertions.checkNotNull(trackSelectorResultSelectTracks);
        long jApplyTrackSelection = applyTrackSelection(trackSelectorResultSelectTracks, this.info.startPositionUs, false);
    ...
    public TrackSelectorResult selectTracks(float f, Timeline timeline) throws ExoPlaybackException {
        ...
        if (trackSelectorResultSelectTracks.isEquivalent(this.trackSelectorResult)) {
            return null;
        }
    ...
    private static MediaPeriod createMediaPeriod(MediaSource.MediaPeriodId mediaPeriodId, MediaSource mediaSource, Allocator allocator, long j, long j2) {
        ...
        return (j2 == C.TIME_UNSET || j2 == Long.MIN_VALUE) ? mediaPeriodCreatePeriod : new ClippingMediaPeriod(mediaPeriodCreatePeriod, true, 0L, j2);
    }
