...
public final class MlltFrame extends Id3Frame {
    ...
    MlltFrame(Parcel parcel) {
        ...
        Util.castNonNull(iArrCreateIntArray);
        this.bytesDeviations = iArrCreateIntArray;
        int[] iArrCreateIntArray2 = parcel.createIntArray();
        Util.castNonNull(iArrCreateIntArray2);
        this.millisecondsDeviations = iArrCreateIntArray2;
    }
