...
public class SsManifestParser implements ParsingLoadable.Parser<SsManifest> {
    ...
    private static class QualityLevelParser extends ElementParser {
        ...
        public void parseStartTag(XmlPullParser xmlPullParser) throws ParserException {
            ...
            if (iIntValue == 2) {
                this.format = Format.createVideoContainerFormat(attributeValue, str, MimeTypes.VIDEO_MP4, strFourCCToMimeType, null, null, requiredInt, parseRequiredInt(xmlPullParser, KEY_MAX_WIDTH), parseRequiredInt(xmlPullParser, KEY_MAX_HEIGHT), -1.0f, buildCodecSpecificData(xmlPullParser.getAttributeValue(null, KEY_CODEC_PRIVATE_DATA)), 0, 0);
                return;
            }
            if (iIntValue == 1) {
                ...
                this.format = Format.createAudioContainerFormat(attributeValue, str, MimeTypes.AUDIO_MP4, strFourCCToMimeType, null, null, requiredInt, requiredInt2, requiredInt3, listBuildCodecSpecificData, 0, 0, (String) getNormalizedAttribute(KEY_LANGUAGE));
                return;
            }
            if (iIntValue == 3) {
                ...
                if (iHashCode != 2061026) {
                    if (iHashCode == 2094737 && str2.equals("DESC")) {
                        c = 1;
                    }
                } else if (str2.equals("CAPT")) {
                    c = 0;
                }
                this.format = Format.createTextContainerFormat(attributeValue, str, MimeTypes.APPLICATION_MP4, strFourCCToMimeType, null, requiredInt, 0, c != 0 ? c != 1 ? 0 : 1024 : 64, (String) getNormalizedAttribute(KEY_LANGUAGE));
                return;
            }
            this.format = Format.createContainerFormat(attributeValue, str, MimeTypes.APPLICATION_MP4, strFourCCToMimeType, null, requiredInt, 0, 0, null);
        }
