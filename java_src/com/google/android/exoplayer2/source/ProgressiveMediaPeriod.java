...
final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    public void onLoadCompleted(ExtractingLoadable extractingLoadable, long j, long j2) {
        ...
        if (this.durationUs == C.TIME_UNSET && (seekMap = this.seekMap) != null) {
            ...
            this.listener.onSourceInfoRefreshed(this.durationUs, zIsSeekable);
        }
    ...
    private boolean seekInsideBufferUs(boolean[] zArr, long j) {
        ...
        while (true) {
            ...
            SampleQueue sampleQueue = this.sampleQueues[i];
            sampleQueue.rewind();
            if (!(sampleQueue.advanceTo(j, true, false) != -1) && (zArr[i] || !this.haveAudioVideoTracks)) {
                break;
            }
            i++;
        }
    ...
    final class ExtractingLoadable implements Loader.Loadable, IcyDataSource.Listener {
        ...
        public void load() throws Throwable {
            ...
            while (i == 0 && !this.loadCanceled) {
                ...
                try {
                    ...
                    try {
                        Extractor extractorSelectExtractor = this.extractorHolder.selectExtractor(defaultExtractorInput2, this.extractorOutput, uri2);
        ...
        public void onIcyMetadata(ParsableByteArray parsableByteArray) {
            ...
            trackOutput2.sampleData(parsableByteArray, iBytesLeft);
            trackOutput2.sampleMetadata(jMax, 1, iBytesLeft, 0, null);
