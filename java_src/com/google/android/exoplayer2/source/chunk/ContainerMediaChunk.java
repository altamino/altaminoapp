    ...
    public final void load() throws InterruptedException, IOException {
        ...
        try {
            ...
            if (this.nextLoadPosition == 0) {
                ...
                this.extractorWrapper.init(getTrackOutputProvider(output), this.clippedStartTimeUs == C.TIME_UNSET ? -9223372036854775807L : this.clippedStartTimeUs - this.sampleOffsetUs, this.clippedEndTimeUs == C.TIME_UNSET ? -9223372036854775807L : this.clippedEndTimeUs - this.sampleOffsetUs);
            }
            try {
