...
public class h implements b {
    ...
    private static Pair<ByteBuffer, Long> a(RandomAccessFile randomAccessFile, long j) throws c, IOException {
        if (j < 32) {
    ...
    private static void a(Map<Integer, byte[]> map, FileChannel fileChannel, long j, long j2, long j3, ByteBuffer byteBuffer) throws SecurityException {
        ...
        try {
            byte[][] bArrA = a(iArr, new b[]{aVar, aVar2, hVar});
    ...
    private static boolean a(int i) {
        ...
        switch (i) {
            case MasterTemplatePickerFragment.API_ERR_COMMUNITY_USER_CREATED_COMMUNITIES_VERIFY /* 257 */:
    ...
    private static X509Certificate[] a(ByteBuffer byteBuffer, Map<Integer, byte[]> map, CertificateFactory certificateFactory) throws InvalidKeySpecException, NoSuchAlgorithmException, SignatureException, IOException, InvalidKeyException, SecurityException, InvalidAlgorithmParameterException {
        ...
        String strE = e(i);
        Pair<String, ? extends AlgorithmParameterSpec> pairF = f(i);
        ...
        try {
            ...
            int iB = b(i);
            byte[] bArrPut = map.put(Integer.valueOf(iB), bArrC3);
            ...
            while (byteBufferB6.hasRemaining()) {
                ...
                try {
                    arrayList3.add(new f((X509Certificate) certificateFactory.generateCertificate(new ByteArrayInputStream(bArrC4)), bArrC4));
    ...
    private static byte[][] a(int[] iArr, b[] bVarArr) throws DigestException {
        ...
        for (int i4 = 0; i4 < iArr.length; i4++) {
            String strC = c(iArr[i4]);
            try {
                messageDigestArr[i4] = MessageDigest.getInstance(strC);
        ...
        while (i5 < length) {
            ...
            while (jA2 > j) {
                ...
                long j3 = j2;
                try {
                    bVar2.a(messageDigestArr, j3, iMin);
                    int i8 = 0;
                    while (i8 < iArr.length) {
                        ...
                        int iDigest = messageDigest2.digest(bArr6, (i6 * iD) + 5, iD);
                        if (iDigest != iD) {
        ...
        for (int i11 = 0; i11 < iArr.length; i11++) {
            ...
            String strC2 = c(i12);
            try {
                bArr8[i11] = MessageDigest.getInstance(strC2).digest(bArr9);
    ...
    private static X509Certificate[][] a(RandomAccessFile randomAccessFile) throws c, IOException, SecurityException {
        return a(randomAccessFile.getChannel(), b(randomAccessFile));
    }

    public static X509Certificate[][] a(String str) throws c, IOException, SecurityException {
    ...
    private static X509Certificate[][] a(FileChannel fileChannel, d dVar) throws SecurityException, CertificateException {
        HashMap map = new HashMap();
        ArrayList arrayList = new ArrayList();
        try {
            CertificateFactory certificateFactory = CertificateFactory.getInstance("X.509");
            try {
                ByteBuffer byteBufferB = b(dVar.a);
                int i = 0;
    ...
    */
    private static com.google.android.play.core.internal.d b(java.io.RandomAccessFile r12) throws com.google.android.play.core.internal.c, java.io.IOException {
        /*
    ...
    private static Pair<ByteBuffer, Long> c(RandomAccessFile randomAccessFile) throws c, IOException {
        ...
        if (randomAccessFile.length() < 22) {
            ...
            if (pairA == null) {
                pairA = a(randomAccessFile, SupportMenu.USER_MASK);
            }
        }
        if (pairA != null) {
            return pairA;
