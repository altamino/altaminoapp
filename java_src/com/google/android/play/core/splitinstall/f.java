...
public class f {
    ...
    f(l lVar, SplitInstallSessionState splitInstallSessionState, Intent intent, Context context) {
        this.d = lVar;
    ...
    public void b() {
        if (this.b.getBooleanExtra("triggered_from_app_after_verification", false)) {
            ((a) this.d).a.d("Splits copied and verified more than once.", new Object[0]);
        } else {
