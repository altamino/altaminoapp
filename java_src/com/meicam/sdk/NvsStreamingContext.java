...
public class NvsStreamingContext {
    ...
    public static NvsStreamingContext init(Context context, String str, int i) throws Exception {
        boolean z;
        NvsUtils.checkFunctionInMainThread();
    ...
    public static boolean initHumanDetection(Context context, String str, String str2, int i) throws ClassNotFoundException {
        tryLoadFaceDetectionLibrary();
    ...
    public boolean startRecording(String str, int i, Hashtable<String, Object> hashtable) {
        ...
        if (hashtable != null) {
            ...
            if (number2 != null) {
                ...
                i2 = iIntValue2;
                return nativeStartRecording(str, this.m_recordVideoBitrateMultiplier, i2, iIntValue, i);
            }
            i2 = iIntValue2;
        } else {
            i2 = 0;
