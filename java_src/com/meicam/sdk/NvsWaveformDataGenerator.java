...
public class NvsWaveformDataGenerator {
    ...
    public long generateWaveformData(String str, long j, long j2, long j3, int i) {
        ...
        long jNativeFetchWaveformData = nativeFetchWaveformData(this.m_waveformDataGenerator, str, j, j2, j3);
    ...
    protected void notifyWaveformDataReady(long j, long j2, long j3, float[] fArr, float[] fArr2) {
        long j4;
