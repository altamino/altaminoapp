...
public final class C0757Ns extends LinearLayout {
    public C0757Ns(Context context, NativeBannerAd nativeBannerAd, LJ lj, LI li, AdOptionsView adOptionsView) {
        super(context);
        ...
        textView2.setLines(lj == LJ.A07 ? 2 : 1);
