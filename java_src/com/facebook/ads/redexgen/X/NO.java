...
public final class NO implements Window.Callback {
    private static final List<InterfaceC0414Ah> A02 = Collections.synchronizedList(new ArrayList());
    private Activity A00;
    private Window.Callback A01;

    public NO(Window.Callback callback, Activity activity) {
        this.A01 = callback;
        this.A00 = activity;
    }

    public static void A00(InterfaceC0414Ah interfaceC0414Ah) {
        A02.add(interfaceC0414Ah);
    }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        Iterator<InterfaceC0414Ah> it = A02.iterator();
        char c = 2;
        while (true) {
            switch (c) {
                case 2:
