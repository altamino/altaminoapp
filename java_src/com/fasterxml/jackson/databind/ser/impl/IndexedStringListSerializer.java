...
public final class IndexedStringListSerializer extends StaticListSerializerBase<List<String>> implements ContextualSerializer {
    ...
    public JsonSerializer<?> createContextual(SerializerProvider serializerProvider, BeanProperty beanProperty) throws JsonMappingException {
        ...
        return jsonSerializerHandleSecondaryContextualization == this._serializer ? this : new IndexedStringListSerializer(jsonSerializerHandleSecondaryContextualization);
    }
