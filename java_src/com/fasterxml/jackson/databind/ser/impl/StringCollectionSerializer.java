...
public class StringCollectionSerializer extends StaticListSerializerBase<Collection<String>> implements ContextualSerializer {
    ...
    public JsonSerializer<?> createContextual(SerializerProvider serializerProvider, BeanProperty beanProperty) throws JsonMappingException {
        ...
        if (isDefaultSerializer(jsonSerializerHandleSecondaryContextualization)) {
            jsonSerializerHandleSecondaryContextualization = null;
        }
        return jsonSerializerHandleSecondaryContextualization == this._serializer ? this : new StringCollectionSerializer(jsonSerializerHandleSecondaryContextualization);
    }
    ...
    private void serializeUsingCustom(Collection<String> collection, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
