...
public class StringArraySerializer extends ArraySerializerBase<String[]> implements ContextualSerializer {
    ...
    public JsonSerializer<?> createContextual(SerializerProvider serializerProvider, BeanProperty beanProperty) throws JsonMappingException {
        ...
        return jsonSerializerHandleSecondaryContextualization == this._elementSerializer ? this : new StringArraySerializer(this, beanProperty, jsonSerializerHandleSecondaryContextualization);
    }
