...
public class NumberSerializers {
    ...
    public static final class NumberSerializer extends StdScalarSerializer<Number> {
        ...
        @Override // com.fasterxml.jackson.databind.JsonSerializer
        public void serialize(Number number, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws UnsupportedOperationException, IOException {
