...
public final class AnnotatedClass extends Annotated {
    ...
    private void resolveFields() {
        ...
        if (map_findFields == null || map_findFields.size() == 0) {
            ...
            this._fields = new ArrayList(map_findFields.size());
            this._fields.addAll(map_findFields.values());
        }
    }
    ...
    protected AnnotatedConstructor _constructConstructor(Constructor<?> constructor, boolean z) {
        ...
        return new AnnotatedConstructor(constructor, _collectRelevantAnnotations(constructor.getDeclaredAnnotations()), annotationMapArr_collectRelevantAnnotations);
    }
