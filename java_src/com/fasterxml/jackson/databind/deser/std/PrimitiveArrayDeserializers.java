...
public abstract class PrimitiveArrayDeserializers<T> extends StdDeserializer<T> {
    ...
    static final class ShortDeser extends PrimitiveArrayDeserializers<short[]> {
        ...
        @Override // com.fasterxml.jackson.databind.JsonDeserializer
        public short[] deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws NumberFormatException, IOException {
            if (!jsonParser.isExpectedStartArrayToken()) {
                return handleNonArray(jsonParser, deserializationContext);
            }
    ...
    static final class IntDeser extends PrimitiveArrayDeserializers<int[]> {
        ...
        @Override // com.fasterxml.jackson.databind.JsonDeserializer
        public int[] deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws NumberFormatException, IOException {
            if (!jsonParser.isExpectedStartArrayToken()) {
                return handleNonArray(jsonParser, deserializationContext);
            }
