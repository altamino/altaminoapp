...
public class JsonLocationInstantiator extends ValueInstantiator {
    ...
    public CreatorProperty[] getFromObjectArguments(DeserializationConfig deserializationConfig) {
        ...
        return new CreatorProperty[]{creatorProp("sourceRef", deserializationConfig.constructType(Object.class), 0), creatorProp("byteOffset", javaTypeConstructType2, 1), creatorProp("charOffset", javaTypeConstructType2, 2), creatorProp("lineNr", javaTypeConstructType, 3), creatorProp("columnNr", javaTypeConstructType, 4)};
    }
