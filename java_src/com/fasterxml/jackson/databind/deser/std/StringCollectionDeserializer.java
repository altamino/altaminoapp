...
public final class StringCollectionDeserializer extends ContainerDeserializerBase<Collection<String>> implements ContextualDeserializer {
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext deserializationContext, BeanProperty beanProperty) throws JsonMappingException {
        ...
        if (jsonDeserializer == null) {
            ...
            jsonDeserializerHandleSecondaryContextualization = jsonDeserializerFindConvertingContentDeserializer == null ? deserializationContext.findContextualValueDeserializer(this._collectionType.getContentType(), beanProperty) : jsonDeserializerFindConvertingContentDeserializer;
        } else {
        ...
        if (isDefaultDeserializer(jsonDeserializerHandleSecondaryContextualization)) {
            jsonDeserializerHandleSecondaryContextualization = null;
        }
        return withResolved(jsonDeserializerFindDeserializer, jsonDeserializerHandleSecondaryContextualization);
    }
