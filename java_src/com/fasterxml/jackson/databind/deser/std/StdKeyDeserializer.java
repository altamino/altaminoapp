...
public abstract class StdKeyDeserializer extends KeyDeserializer implements Serializable {
    ...
    static final class ByteKD extends StdKeyDeserializer {
        ...
        @Override // com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer
        public Byte _parse(String str, DeserializationContext deserializationContext) throws JsonMappingException, IllegalArgumentException {
    ...
    static final class ShortKD extends StdKeyDeserializer {
        ...
        @Override // com.fasterxml.jackson.databind.deser.std.StdKeyDeserializer
        public Short _parse(String str, DeserializationContext deserializationContext) throws JsonMappingException, IllegalArgumentException {
            int i_parseInt = _parseInt(str);
