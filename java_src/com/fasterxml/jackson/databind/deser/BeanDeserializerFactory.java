...
public class BeanDeserializerFactory extends BasicDeserializerFactory implements Serializable {
    ...
    protected void addObjectIdReader(DeserializationContext deserializationContext, BeanDescription beanDescription, BeanDeserializerBuilder beanDeserializerBuilder) throws JsonMappingException {
        ...
        beanDeserializerBuilder.setObjectIdReader(ObjectIdReader.construct(type, objectIdInfo.getPropertyName(), objectIdGeneratorObjectIdGeneratorInstance, deserializationContext.findRootValueDeserializer(type), settableBeanPropertyFindProperty));
    }
    ...
    public JsonDeserializer<Object> buildThrowableDeserializer(DeserializationContext deserializationContext, JavaType javaType, BeanDescription beanDescription) throws SecurityException, JsonMappingException {
        ...
        beanDeserializerBuilderConstructBeanDeserializerBuilder.addIgnorable(AccountNotice.LEVEL_MESSAGE);
        if (this._factoryConfig.hasDeserializerModifiers()) {
            Iterator<BeanDeserializerModifier> it = this._factoryConfig.deserializerModifiers().iterator();
            while (it.hasNext()) {
                beanDeserializerBuilderConstructBeanDeserializerBuilder = it.next().updateBuilder(config, beanDescription, beanDeserializerBuilderConstructBeanDeserializerBuilder);
    ...
    */
    protected void addBeanProps(com.fasterxml.jackson.databind.DeserializationContext r12, com.fasterxml.jackson.databind.BeanDescription r13, com.fasterxml.jackson.databind.deser.BeanDeserializerBuilder r14) throws java.lang.SecurityException, com.fasterxml.jackson.databind.JsonMappingException {
        /*
    ...
    protected SettableAnyProperty constructAnySetter(DeserializationContext deserializationContext, BeanDescription beanDescription, AnnotatedMethod annotatedMethod) throws SecurityException, JsonMappingException {
        ...
        return new SettableAnyProperty(std, annotatedMethod, javaTypeModifyTypeByAnnotation, jsonDeserializerFindDeserializerFromAnnotation == null ? (JsonDeserializer) javaTypeModifyTypeByAnnotation.getValueHandler() : jsonDeserializerFindDeserializerFromAnnotation, (TypeDeserializer) javaTypeModifyTypeByAnnotation.getTypeHandler());
    }
    ...
    protected SettableBeanProperty constructSetterlessProperty(DeserializationContext deserializationContext, BeanDescription beanDescription, BeanPropertyDefinition beanPropertyDefinition) throws SecurityException, JsonMappingException {
        AnnotatedMethod getter = beanPropertyDefinition.getGetter();
        if (deserializationContext.canOverrideAccessModifiers()) {
            getter.fixAccess();
        }
        JavaType type = getter.getType(beanDescription.bindingsForBeanType());
        JsonDeserializer<Object> jsonDeserializerFindDeserializerFromAnnotation = findDeserializerFromAnnotation(deserializationContext, getter);
        ...
        return jsonDeserializerFindDeserializerFromAnnotation != null ? setterlessProperty.withValueDeserializer((JsonDeserializer) jsonDeserializerFindDeserializerFromAnnotation) : setterlessProperty;
    }
