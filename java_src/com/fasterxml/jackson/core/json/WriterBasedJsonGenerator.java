...
public final class WriterBasedJsonGenerator extends JsonGeneratorImpl {
  ...
  0x001d: PHI (r4v5 int) = (r4v2 int), (r4v6 int) binds: [B:9:0x0019, B:7:0x0016] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:12:0x001c A[PHI: r3
  ...
  0x0031: PHI (r6v6 int) = (r6v2 int), (r6v7 int) binds: [B:15:0x002d, B:10:0x0020] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:18:0x0030 A[PHI: r5
  0x0030: PHI (r5v5 int) = (r5v1 int), (r5v6 int) binds: [B:16:0x002c, B:11:0x001f] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    private void _prependOrWriteCharacterEscape(char c, int i) throws IOException {
        ...
        if (i != -2) {
            ...
            if (c > 255) {
                ...
                cArr_allocateEntityBuffer2[10] = cArr5[i12 >> 4];
                cArr_allocateEntityBuffer2[11] = cArr5[i12 & 15];
                cArr_allocateEntityBuffer2[12] = cArr5[i13 >> 4];
                cArr_allocateEntityBuffer2[13] = cArr5[i13 & 15];
    ...
    private int _prependOrWriteCharacterEscape(char[] cArr, int i, int i2, char c, int i3) throws IOException {
        ...
        if (c > 255) {
            ...
            int i15 = c & 255;
            char[] cArr4 = HEX_CHARS;
            cArr_allocateEntityBuffer2[10] = cArr4[i14 >> 4];
            cArr_allocateEntityBuffer2[11] = cArr4[i14 & 15];
            cArr_allocateEntityBuffer2[12] = cArr4[i15 >> 4];
            cArr_allocateEntityBuffer2[13] = cArr4[i15 & 15];
            this._writer.write(cArr_allocateEntityBuffer2, 8, 6);
            return i;
        }
        char[] cArr5 = HEX_CHARS;
