...
public class GradientStrokeContent extends BaseStrokeContent {
    ...
    private LinearGradient getLinearGradient() {
        ...
        int iWidth = (int) (rectF.left + (rectF.width() / 2.0f) + value.x);
        RectF rectF2 = this.boundsRect;
        int iHeight = (int) (rectF2.top + (rectF2.height() / 2.0f) + value.y);
        RectF rectF3 = this.boundsRect;
        int iWidth2 = (int) (rectF3.left + (rectF3.width() / 2.0f) + value2.x);
        RectF rectF4 = this.boundsRect;
        LinearGradient linearGradient2 = new LinearGradient(iWidth, iHeight, iWidth2, (int) (rectF4.top + (rectF4.height() / 2.0f) + value2.y), colors, positions, Shader.TileMode.CLAMP);
    ...
    private RadialGradient getRadialGradient() {
        ...
        int iWidth2 = (int) (rectF3.left + (rectF3.width() / 2.0f) + value2.x);
        RectF rectF4 = this.boundsRect;
        RadialGradient radialGradient2 = new RadialGradient(iWidth, iHeight, (float) Math.hypot(iWidth2 - iWidth, ((int) ((rectF4.top + (rectF4.height() / 2.0f)) + value2.y)) - iHeight), colors, positions, Shader.TileMode.CLAMP);
