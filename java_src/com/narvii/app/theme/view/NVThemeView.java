...
public final class NVThemeView extends View implements NVThemeObserver, NVDarkBackground {
    ...
    public NVThemeView(Context context) {
        this(context, null, 0, 6, null);
    }

    public NVThemeView(Context context, AttributeSet attributeSet) {
    ...
    public NVThemeView(Context context, AttributeSet attributeSet, int i) {
    ...
    public /* synthetic */ NVThemeView(Context context, AttributeSet attributeSet, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public static final class Companion {
        ...
        public final Drawable getDarkBackgroundDrawable(TypedArray a, Context context) {
            Intrinsics.checkParameterIsNotNull(a, "a");
            Intrinsics.checkParameterIsNotNull(context, "context");
            return a.getDrawable(R.styleable.NVDarkTheme_nv_dark_background);
        }
    }
