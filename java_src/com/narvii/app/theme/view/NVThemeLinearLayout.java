...
/* compiled from: NVThemeLinearLayout.kt */
...
public final class NVThemeLinearLayout extends LinearLayout implements NVThemeObserver, NVDarkBackground {
    ...
    public NVThemeLinearLayout(Context context) {
        this(context, null, 0, 6, null);
    }

    public NVThemeLinearLayout(Context context, AttributeSet attributeSet) {
    ...
    public NVThemeLinearLayout(Context context, AttributeSet attributeSet, int i) {
    ...
    public /* synthetic */ NVThemeLinearLayout(Context context, AttributeSet attributeSet, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
