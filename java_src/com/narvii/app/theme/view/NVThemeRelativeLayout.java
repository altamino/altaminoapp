...
/* compiled from: NVThemeRelativeLayout.kt */
/* loaded from: classes2.dex */
public final class NVThemeRelativeLayout extends RelativeLayout implements NVThemeObserver, NVDarkBackground {
    private HashMap _$_findViewCache;
    private Drawable darkBackgroundDrawable;
    private Drawable lightBackgroundDrawable;
    private int nvThemeValue;

    public NVThemeRelativeLayout(Context context) {
        this(context, null, 0, 6, null);
    }

    public NVThemeRelativeLayout(Context context, AttributeSet attributeSet) {
    ...
    public NVThemeRelativeLayout(Context context, AttributeSet attributeSet, int i) {
    ...
    public /* synthetic */ NVThemeRelativeLayout(Context context, AttributeSet attributeSet, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
