...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private final Drawable.Callback mCallback = new Drawable.Callback() { // from class: com.narvii.list.refresh.MaterialProgressDrawable.3
    ...
    private static class Ring {
        ...
        private void drawTriangle(Canvas canvas, float f, float f2, Rect rect) {
            if (this.mShowArrow) {
                ...
                double dCos = this.mRingCenterRadius * Math.cos(0.0d);
                double dExactCenterX = rect.exactCenterX();
                Double.isNaN(dExactCenterX);
                float f4 = (float) (dCos + dExactCenterX);
                double dSin = this.mRingCenterRadius * Math.sin(0.0d);
                double dExactCenterY = rect.exactCenterY();
                Double.isNaN(dExactCenterY);
                float f5 = (float) (dSin + dExactCenterY);
