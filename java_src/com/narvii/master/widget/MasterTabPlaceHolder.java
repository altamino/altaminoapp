...
public class MasterTabPlaceHolder extends FrameLayout {
    private int masterTabHeight;
    private int statusBarHeight;

    public MasterTabPlaceHolder(Context context) {
        this(context, null);
    }

    public MasterTabPlaceHolder(Context context, AttributeSet attributeSet) {
