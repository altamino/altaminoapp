...
public class LiveLayerOnlineBar extends FrameLayout implements ILiveLayerView {
    ...
    public interface OnUpdateMemberCountListener {
        void onUpdateMemberCount(int i);
    }
    ...
    public LiveLayerOnlineBar(Context context, AttributeSet attributeSet) {
        ...
        this.dataSource = new LiveLayerDataSource(nVContext);
        this.dataSource.setLiveLayerView(this);
        ...
        this.avatarShadowSize = this.showShadow ? Utils.dpToPxInt(getContext(), 3.0f) : 0;
        this.avatarSize = this.defaultAvatarSize;
        this.mainLayout = (ClipLayout) findViewById(R.id.main_layout);
        this.greenOval = findViewById(R.id.green_oval);
        ViewUtils.setMarginStart(this.greenOval.getLayoutParams(), (this.avatarSize / 2) + getContext().getResources().getDimensionPixelSize(R.dimen.live_layer_green_oval_marginStart));
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.narvii.livelayer.LiveLayerOnlineBar.onTouchEvent(android.view.MotionEvent):boolean");
    }

    public void setForceHideOnlineTextLayout(boolean z) {
        this.forceHideOnlineTextLayout = z;
    }
    ...
    public void setLift(int i) {
        ...
        layoutParams.bottomMargin = i + getContext().getResources().getDimensionPixelSize(R.dimen.live_layer_online_bar_margin_bottom);
        setLayoutParams(layoutParams);
    }

    public void setShouldFilterUserList(boolean z) {
        this.shouldFilterUserList = z;
    }
    ...
    private void onAvatarSizeChanged() {
        ...
        if (clipLayout != null) {
            ...
            int i = 0;
            while (i < this.mainLayout.getChildCount()) {
                i++;
        ...
        if (view2 != null) {
            ...
            layoutParams2.width = i4 + iDpToPx;
            layoutParams2.height = i4 + iDpToPx;
    ...
    protected void onAttachedToWindow() {
        ...
        Utils.handler.removeCallbacks(this.dataSource.checkRunnable);
        Utils.handler.postDelayed(this.dataSource.checkRunnable, 2000L);
    }
    ...
    public void moveLayout(int i) {
        int i2 = (int) (this.avatarSize * (1.0f - this.overlapRatio));
        int i3 = 0;
        int i4 = 0;
        while (true) {
            int i5 = this.avatarCount;
            if (i3 < i5 - 1) {
                View childAt = this.mainLayout.getChildAt((i5 - 1) - i3);
                ViewGroup.LayoutParams layoutParams = childAt.getLayoutParams();
                ViewUtils.setMarginStart(layoutParams, (i2 * i4) + i);
                childAt.setLayoutParams(layoutParams);
                i4++;
                i3++;
            } else {
                resetShadowColor(0);
                ViewGroup.LayoutParams layoutParams2 = this.onlineTextLayout.getLayoutParams();
                int i6 = this.avatarSize;
                ViewUtils.setMarginStart(layoutParams2, (int) (((i + ((i6 * (1.0f - this.overlapRatio)) * (this.avatarCount - 2))) + i6) - (i6 / 2)));
                this.onlineTextLayout.setLayoutParams(layoutParams2);
                return;
            }
        }
    }
    ...
    private void changeX(int i) {
        for (int i2 = 0; i2 < this.mainLayout.getChildCount(); i2++) {
            this.mainLayout.getChildAt(i2).setX(i);
        }
    }
    ...
    public void setUserAvatarView(UserAvatarLayout userAvatarLayout, User user) {
        ...
        int i = this.avatarStrokeWidth;
        if (i != -1) {
            userAvatarLayout.setAvatarStroke(i);
        }
    }
    ...
    public void setUserList(List<User> list, int i) {
        setUserList(list, i, true);
    }

    public void setUserList(List<User> list, int i, boolean z) throws Resources.NotFoundException {
        UserAvatarLayout userAvatarLayout;
        this.organizerInList = z;
        if (this.shouldFilterUserList) {
            list = this.dataSource.filterHelper.filter(list);
        }
        int size = CollectionUtils.getSize(list);
        if (size < this.maxAvatarCount && z) {
            i = Math.min(i, size);
        }
        ...
        relayout();
        this.dataSource.setCurrentMembersCount(Math.max(i, this.avatarCount));
    ...
    private void cancelAnimation(boolean z) {
        ...
        Utils.handler.removeCallbacks(this.dataSource.correctMembersCountRunnable);
    }
    ...
    public void onMembersCountChanged(int i) {
        ...
        int i2 = this.dataSource.currentMembersCount;
        if (i != i2) {
            this.animator = ValueAnimator.ofInt(i, i2);
            this.animator.setDuration(Math.min(800, Math.abs(this.dataSource.currentMembersCount - i) * 100));
    ...
    public void updateMemberCount(int i) {
        ...
        if (onUpdateMemberCountListener != null) {
            onUpdateMemberCountListener.onUpdateMemberCount(i);
        }
    }
    ...
    private void resetMoreLayer() {
        ...
        int i3 = this.dataSource.currentMembersCount > this.avatarCount ? 0 : 8;
    ...
    public void goFold(boolean z) {
        if (this.supportFold) {
            NVContext nVContext = Utils.getNVContext(getContext());
            boolean z2 = !liveLayerBarStated;
            if (this.fold != z) {
                ...
                sharedPreferences.edit().putBoolean("liveLayerFold", z).apply();
                z2 |= boolValueOf != Boolean.valueOf(z);
            }
            if (z2) {
            ...
            if (this.supportFold) {
                ...
                if (viewFindViewById == null) {
                    ...
                    this.foldCountView = (TextView) viewFindViewById.findViewById(R.id.online_count);
                    ViewGroup.LayoutParams layoutParams = this.foldCountView.getLayoutParams();
                ...
                viewFindViewById.setVisibility((!z || this.avatarCount < this.minAvatarCount) ? 8 : 0);
            }
    ...
    public void onUserJoined(User user) {
        ...
        this.userJoinedView = LayoutInflater.from(getContext()).inflate((this.fold || this.fromCBB) ? R.layout.live_layer_online_member_new_user_fold : R.layout.live_layer_online_member_new_user, (ViewGroup) this, false);
        ...
        Utils.handler.removeCallbacks(this.joinAnimRunnable);
        this.joinAnimRunnable = new AnonymousClass7(user);
        Utils.postDelayed(this.joinAnimRunnable, 1500L);
    }

    /* renamed from: com.narvii.livelayer.LiveLayerOnlineBar$7, reason: invalid class name */
        ...
        public void run() {
                ...
                public void run() throws Resources.NotFoundException {
                    ...
                    if (liveLayerOnlineBar.fromCBB) {
                        ...
                        if (viewFindViewById2 != null) {
                            LiveLayerOnlineBar liveLayerOnlineBar2 = LiveLayerOnlineBar.this;
                            liveLayerOnlineBar2.fadeoutAnim = AnimationUtils.loadAnimation(liveLayerOnlineBar2.getContext(), R.anim.fade_out);
                        ...
                        LiveLayerOnlineBar.this.startHoloAnimation(anonymousClass72.val$user);
                        ...
                        LiveLayerOnlineBar.startAnimation(viewFindViewById3, scaleAnimation2, new Animation.AnimationListener() { // from class: com.narvii.livelayer.LiveLayerOnlineBar.7.1.4
                            ...
                            public void onAnimationEnd(Animation animation) {
                                ...
                                liveLayerOnlineBar3.removeView(liveLayerOnlineBar3.userJoinedView);
                            }
                        });
                    } else {
                        ...
                        if (liveLayerOnlineBar3.foldGreenOval != null) {
                            liveLayerOnlineBar3.dotFadeInAnimation = AnimationUtils.loadAnimation(liveLayerOnlineBar3.getContext(), R.anim.fade_in);
                            ...
                            LiveLayerOnlineBar.startAnimation(liveLayerOnlineBar4.foldGreenOval, liveLayerOnlineBar4.dotFadeInAnimation, null);
                        }
                    }
                    ...
                    liveLayerDataSource.currentMembersCount++;
                    liveLayerOnlineBar6.onMembersCountChanged(liveLayerDataSource.currentMembersCount - 1);
                    AnonymousClass7 anonymousClass73 = AnonymousClass7.this;
                    View avatarView = LiveLayerOnlineBar.this.getAvatarView(anonymousClass73.val$user);
                    ...
                    liveLayerOnlineBar8.setUserAvatarView(liveLayerOnlineBar8.recentAvatar, anonymousClass74.val$user);
                    LiveLayerOnlineBar liveLayerOnlineBar9 = LiveLayerOnlineBar.this;
                    liveLayerOnlineBar9.avatarCount++;
                    final int i = (int) (liveLayerOnlineBar9.avatarSize * (1.0f - liveLayerOnlineBar9.overlapRatio));
                    ...
                    if (!liveLayerOnlineBar10.fold) {
                        liveLayerOnlineBar10.layoutAnimator = ValueAnimator.ofInt(0, i);
                        ...
                        LiveLayerOnlineBar.this.layoutAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.narvii.livelayer.LiveLayerOnlineBar.7.1.5
                            ...
                            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                                ...
                                while (true) {
                                    ...
                                    i2 = liveLayerOnlineBar11.avatarCount;
                                    if (i3 >= i2 - 1) {
                                        break;
                                    }
                                    View childAt = liveLayerOnlineBar11.mainLayout.getChildAt((i2 - 1) - i3);
                                    ViewGroup.LayoutParams layoutParams = childAt.getLayoutParams();
                                    float f = iIntValue;
                                    ViewUtils.setMarginStart(layoutParams, (int) ((r5.avatarSize * (1.0f - LiveLayerOnlineBar.this.overlapRatio) * i4) + f));
                                    childAt.setLayoutParams(layoutParams);
                                    i4++;
                                    if (!z && i3 == LiveLayerOnlineBar.this.avatarCount - 2) {
                                        int i5 = i;
                                ...
                                if (i2 > 0) {
                                    try {
                                        UserAvatarLayout userAvatarLayout = (UserAvatarLayout) liveLayerOnlineBar11.mainLayout.getChildAt(i2 - 1).findViewById(R.id.user_avatar_layout);
                                        if (userAvatarLayout != null) {
                                ...
                                if (z) {
                                    ...
                                    int i8 = LiveLayerOnlineBar.this.avatarSize;
                    ...
                    Utils.handler.removeCallbacks(LiveLayerOnlineBar.this.dataSource.correctMembersCountRunnable);
                    Utils.handler.postDelayed(LiveLayerOnlineBar.this.dataSource.correctMembersCountRunnable, 2000L);
                    Utils.handler.removeCallbacks(LiveLayerOnlineBar.this.nextRunnable);
                    Utils.postDelayed(LiveLayerOnlineBar.this.nextRunnable, r1.getRandomDelayTime());
            ...
            if (!liveLayerOnlineBar.fromCBB) {
                ...
                if (!liveLayerOnlineBar2.fold) {
                    if (Utils.isRtl()) {
                        LiveLayerOnlineBar.this.userJoinedAnim = new TranslateAnimation(-Utils.getScreenWidth(r1.getContext()), 0.0f, 0.0f, 0.0f);
                    } else {
                        LiveLayerOnlineBar.this.userJoinedAnim = new TranslateAnimation(Utils.getScreenWidth(r1.getContext()), 0.0f, 0.0f, 0.0f);
                    }
    ...
    public void startHoloAnimation(User user) {
        View viewFindViewById = findViewById(R.id.live_layer_halo);
        if (viewFindViewById != null) {
            viewFindViewById.setBackgroundResource(user.isSubscribeMemberShip() ? R.drawable.live_layer_halo_amino_plus : R.drawable.live_layer_halo);
    ...
    private void setUpTextLayout() {
        ...
        int i = this.avatarSize;
        int i2 = (int) ((i * (1.0f - this.overlapRatio) * (this.avatarCount - 1)) + i);
        if (this.fold) {
            ViewUtils.setMarginStart(this.onlineTextLayout, i - getResources().getDisplayMetrics().widthPixels);
        } else {
            ViewUtils.setMarginStart(this.onlineTextLayout, i2 - (i / 2));
        }
    }

    private void adjustOnlineTextBarWidth(boolean z) {
        ViewUtils.setMarginStart(this.greenOval.getLayoutParams(), getContext().getResources().getDimensionPixelSize(R.dimen.live_layer_green_oval_marginStart) + (z ? this.avatarSize / 2 : 0));
    }

    private int getExpandWidth() {
        int i = this.avatarSize;
        int i2 = ((int) (((i * (1.0f - this.overlapRatio)) * (this.avatarCount - 1)) + i)) - (i / 2);
        View view = this.onlineTextLayout;
    ...
    protected void onMeasure(int i, int i2) throws Resources.NotFoundException {
        ...
        if ((this.autoFitAvatarCountMax != -1 || this.autoFitAvatarSize) && mode != 0 && measuredWidth != this.maxWidth) {
            ...
            if (this.autoFitAvatarSize) {
                ...
                if (i4 != -1) {
                    int iMin = Math.min(i4, (int) (((measuredWidth - this.defaultAvatarSize) / (this.avatarSize * (1.0f - this.overlapRatio))) + 1.0f));
        ...
        setMeasuredDimension(getMeasuredWidth(), (this.supportFold ? getContext().getResources().getDimensionPixelSize(R.dimen.live_layer_fold_height) : this.avatarSize) + getPaddingTop() + getPaddingBottom());
    }
