...
public class Texture2dProgram {
    ...
    public Texture2dProgram(ProgramType programType) {
        ...
        int i = AnonymousClass1.$SwitchMap$com$narvii$video$gles$Texture2dProgram$ProgramType[programType.ordinal()];
        if (i == 1) {
        ...
        this.maPositionLoc = GLES20.glGetAttribLocation(this.mProgramHandle, BaseFilter.aPosition);
        GlUtil.checkLocation(this.maPositionLoc, BaseFilter.aPosition);
    ...
    /* renamed from: com.narvii.video.gles.Texture2dProgram$1, reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$narvii$video$gles$Texture2dProgram$ProgramType = new int[ProgramType.values().length];

        static {
            try {
                $SwitchMap$com$narvii$video$gles$Texture2dProgram$ProgramType[ProgramType.TEXTURE_2D.ordinal()] = 1;
