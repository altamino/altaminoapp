...
public class Drawable2d {
    ...
    /* renamed from: com.narvii.video.gles.Drawable2d$1, reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$narvii$video$gles$Drawable2d$Prefab = new int[Prefab.values().length];

        static {
            try {
                $SwitchMap$com$narvii$video$gles$Drawable2d$Prefab[Prefab.TRIANGLE.ordinal()] = 1;
    ...
    public Drawable2d(Prefab prefab) {
        int i = AnonymousClass1.$SwitchMap$com$narvii$video$gles$Drawable2d$Prefab[prefab.ordinal()];
        if (i == 1) {
