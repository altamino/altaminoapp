...
public class RtcEngineImpl extends RtcEngineEx implements IAudioEffectManager {
    ...
    private native int nativeStartDumpVideoReceiveTrack(long j, int i);
    ...
    private void setDeviceOrientation(int i) {
        ...
        double d = i;
        Double.isNaN(d);
        int iRound = ((int) (Math.round(d / 90.0d) * 90)) % 360;
        int i2 = iRound - i;
        if (Math.abs(i2) < 20) {
            c = 1;
        } else {
    ...
    private String getAssetsCacheFile(Context context, String str) throws IOException {
        try {
    ...
    @Override // io.agora.rtc.RtcEngine
    public int addVideoWatermark(String str, WatermarkOptions watermarkOptions) throws IOException {
        int i;
        int i2;
        int i3;
        int i4;
        ...
        int i7;
        int i8;
        String assetsCacheFile = str;
        if (assetsCacheFile == null || TextUtils.isEmpty(str) || watermarkOptions == null) {
            return -2;
        }
        if (assetsCacheFile.startsWith("/assets/")) {
            assetsCacheFile = getAssetsCacheFile(this.mContext.get(), assetsCacheFile.replaceFirst("/assets/", ""));
            if (assetsCacheFile == null) {
                return -2;
            }
            Logging.i(TAG, "assets watermark, url: " + assetsCacheFile);
        }
        String str2 = assetsCacheFile;
        ...
        return nativeAddVideoWatermark(this.mNativeHandle, str2, watermarkOptions.visibleInPreview, i, i2, i3, i4, i5, i6, i7, i8);
    }
    ...
    public int joinChannel(String str, String str2, String str3, int i) {
        ...
        return nativeJoinChannel(this.mNativeHandle, null, str, str2, str3, i);
    }
    ...
    public void updateViewOrientation(int i) {
        int iRoundOrientation = roundOrientation(i, this.mOrientation);
    ...
    public int joinChannelWithUserAccount(String str, String str2, String str3) {
        return nativeJoinChannelWithUserAccount(this.mNativeHandle, str, str2, str3);
    }
    ...
    public int adjustRecordingSignalVolume(int i) {
        if (i < 0) {
            ...
            i = WsMessage.LIVE_LAYER_USER_JOINED_EVENT;
        }
        ...
        if (i != 14020) {
            switch (i) {
                ...
                case 101:
                    ...
                    int i3 = pError.err;
                    if ((i3 >= 1151 && i3 <= 1164) || ((i2 = pError.err) >= 1001 && i2 < 1033 && getParameters("che.audio.adm.active").equals("2"))) {
                ...
                case 102:
                    ...
                    int i4 = pError2.err;
                    if ((i4 == 1019 || i4 == 1052) && getParameters("che.audio.adm.active").equals("2")) {
                ...
                default:
                    switch (i) {
                            ...
                            if (i5 == 10) {
                                ...
                                switch (i5) {
                                    ...
                                    default:
                                        if (i5 >= 701 && i5 <= 713) {
                                            if (i5 >= 701 && i5 <= 703) {
                                                iRtcEngineEventHandler.onAudioMixingStateChanged(Constants.MEDIA_ENGINE_AUDIO_EVENT_MIXING_ERROR, i5);
                                                break;
                                            } else {
                                                int i6 = pMediaEngineEvent.code;
                                                if (i6 != 712) {
                                                    iRtcEngineEventHandler.onAudioMixingStateChanged(i6, 0);
                                                    break;
                                                } else {
                        ...
                        case RtcEngineEvent.EvtType.EVT_USER_INFO_UPDATED /* 14035 */:
                            ...
                            int i7 = pUserAccountInfo2.uid;
                            userInfo.uid = i7;
                            userInfo.userAccount = pUserAccountInfo2.userAccount;
                            iRtcEngineEventHandler.onUserInfoUpdated(i7, userInfo);
                            break;
    ...
    public boolean pushExternalVideoFrame(AgoraVideoFrame agoraVideoFrame) {
        ...
        if (i != 10 && i != 11) {
            return i > 0 && i <= 8 && deliverFrame(this.mNativeHandle, agoraVideoFrame.buf, agoraVideoFrame.stride, agoraVideoFrame.height, agoraVideoFrame.cropLeft, agoraVideoFrame.cropTop, agoraVideoFrame.cropRight, agoraVideoFrame.cropBottom, agoraVideoFrame.rotation, agoraVideoFrame.timeStamp, i) == 0;
        }
    ...
    public int startDumpVideoReceiveTrack(int i) {
        return nativeStartDumpVideoReceiveTrack(this.mNativeHandle, i);
    }
