...
public class AudioRoutingController {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            try {
                if (action.equals("android.bluetooth.headset.profile.action.CONNECTION_STATE_CHANGED")) {
                    ...
                    } else if (bluetoothDevice != null && (bluetoothDevice.getBluetoothClass().hasService(2097152) || bluetoothDevice.getBluetoothClass().hasService(AccessibilityEventCompat.TYPE_WINDOWS_CHANGED))) {
                    ...
                    if (intExtra4 != 10) {
                        if (intExtra4 == 12 && (AudioRoutingController.this.mBTAdapter.getProfileConnectionState(2) == 2 || AudioRoutingController.this.mBTAdapter.getProfileConnectionState(1) == 2)) {
                            AudioRoutingController.this.sendEvent(2, 1);
                        }
                    } else {
                        AudioRoutingController.this.sendEvent(2, 0);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public ControllerState changeState(int i) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (i == 2) {
    ...
    private class ControllerStartState extends ControllerBaseState {
        ...
        @Override // io.agora.rtc.internal.AudioRoutingController.ControllerBaseState, io.agora.rtc.internal.AudioRoutingController.ControllerState
        public void onEvent(int i, int i2) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void doStartBTSco(AudioManager audioManager) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        try {
            int mode = audioManager.getMode();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void doStopBTSco(AudioManager audioManager) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    */
    ...
    public void resetAudioRouting() {
        ...
        if (this.mIsBTHeadsetPlugged) {
            ...
            i = this.mForceSpeakerphone == 0 ? 1 : this.mDefaultRouting;
        }
