...
public class VideoEncoderConfiguration {
    ...
    public static final VideoDimensions VD_480x360 = new VideoDimensions(FetchService.QUERY_SINGLE, 360);
    public static final VideoDimensions VD_640x360 = new VideoDimensions(640, 360);
    public static final VideoDimensions VD_480x480 = new VideoDimensions(FetchService.QUERY_SINGLE, FetchService.QUERY_SINGLE);
    public static final VideoDimensions VD_640x480 = new VideoDimensions(640, FetchService.QUERY_SINGLE);
    public static final VideoDimensions VD_840x480 = new VideoDimensions(840, FetchService.QUERY_SINGLE);
    ...
    public static class VideoDimensions {
        ...
        public VideoDimensions() {
            this.width = 640;
            this.height = FetchService.QUERY_SINGLE;
        }
    }
    ...
    public VideoEncoderConfiguration() {
        this.dimensions = new VideoDimensions(640, FetchService.QUERY_SINGLE);
