...
public class RendererCommon {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$io$agora$rtc$gl$RendererCommon$ScalingType = new int[ScalingType.values().length];

        static {
            try {
                $SwitchMap$io$agora$rtc$gl$RendererCommon$ScalingType[ScalingType.SCALE_ASPECT_FIT.ordinal()] = 1;
