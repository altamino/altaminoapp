...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    */
    ...
    @Override // tv.danmaku.ijk.media.player.IMediaPlayer
    @TargetApi(13)
    public void setDataSource(FileDescriptor fileDescriptor) throws IllegalStateException, NoSuchFieldException, IOException, SecurityException, IllegalArgumentException {
    ...
    private void setDataSource(FileDescriptor fileDescriptor, long j, long j2) throws IllegalStateException, NoSuchFieldException, IOException, SecurityException, IllegalArgumentException {
