...
public final class Palette {
    ...
    public static final class Swatch {
        ...
        private void ensureTextColorsGenerated() {
            ...
            int iCalculateMinimumAlpha3 = ColorUtils.calculateMinimumAlpha(ViewCompat.MEASURED_STATE_MASK, this.mRgb, Palette.MIN_CONTRAST_BODY_TEXT);
            int iCalculateMinimumAlpha4 = ColorUtils.calculateMinimumAlpha(ViewCompat.MEASURED_STATE_MASK, this.mRgb, 3.0f);
            if (iCalculateMinimumAlpha3 != -1 && iCalculateMinimumAlpha4 != -1) {
                this.mBodyTextColor = ColorUtils.setAlphaComponent(ViewCompat.MEASURED_STATE_MASK, iCalculateMinimumAlpha3);
                this.mTitleTextColor = ColorUtils.setAlphaComponent(ViewCompat.MEASURED_STATE_MASK, iCalculateMinimumAlpha4);
                this.mGeneratedTextColors = true;
                return;
            }
            if (iCalculateMinimumAlpha != -1) {
                ...
                alphaComponent = ColorUtils.setAlphaComponent(ViewCompat.MEASURED_STATE_MASK, iCalculateMinimumAlpha3);
            }
            ...
            if (iCalculateMinimumAlpha2 != -1) {
                ...
                alphaComponent2 = ColorUtils.setAlphaComponent(ViewCompat.MEASURED_STATE_MASK, iCalculateMinimumAlpha4);
            }
