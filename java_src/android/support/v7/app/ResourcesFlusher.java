...
class ResourcesFlusher {
    ...
    private static boolean flushMarshmallows(Resources resources) throws IllegalAccessException, IllegalArgumentException {
        if (!sDrawableCacheFieldFetched) {
            try {
                sDrawableCacheField = Resources.class.getDeclaredField("mDrawableCache");
                sDrawableCacheField.setAccessible(true);
    ...
    private static boolean flushNougats(Resources resources) throws IllegalAccessException, IllegalArgumentException {
        Object obj;
