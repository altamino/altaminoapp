        ...
        public void onClick(View view) {
            ...
            if (view == alertController.mButtonPositive && (message3 = alertController.mButtonPositiveMessage) != null) {
                ...
                if (view == alertController2.mButtonNegative && (message2 = alertController2.mButtonNegativeMessage) != null) {
                    ...
                    messageObtain = (view != alertController3.mButtonNeutral || (message = alertController3.mButtonNeutralMessage) == null) ? null : Message.obtain(message);
                }
            }
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                ...
                if (cursor == null) {
                    ...
                    checkedItemAdapter = new CursorAdapter(this.mContext, cursor, false) { // from class: android.support.v7.app.AlertController.AlertParams.2
                ...
                if (cursor2 != null) {
                    checkedItemAdapter = new SimpleCursorAdapter(this.mContext, i2, cursor2, new String[]{this.mLabelColumn}, new int[]{android.R.id.text1});
                } else {
