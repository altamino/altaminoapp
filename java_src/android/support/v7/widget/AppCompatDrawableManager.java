...
public final class AppCompatDrawableManager {
    ...
    Drawable getDrawable(Context context, int i, boolean z) throws XmlPullParserException, Resources.NotFoundException, IOException {
    ...
    private Drawable tintDrawable(Context context, int i, boolean z, Drawable drawable) throws Resources.NotFoundException {
    ...
    Drawable onDrawableLoadedFromResources(Context context, VectorEnabledTintResources vectorEnabledTintResources, int i) throws XmlPullParserException, Resources.NotFoundException, IOException {
        Drawable drawableLoadDrawableFromDelegates = loadDrawableFromDelegates(context, i);
        if (drawableLoadDrawableFromDelegates == null) {
    ...
    */
    ...
    ColorStateList getTintList(Context context, int i) throws Resources.NotFoundException {
