...
class AdapterHelper implements OpReorderer.Callback {
    ...
    private void dispatchAndUpdateViewHolders(UpdateOp updateOp) {
        ...
        int i5 = iUpdatePositionWithPostponed;
        int i6 = i3;
        int i7 = 1;
        for (int i8 = 1; i8 < updateOp.itemCount; i8++) {
            int iUpdatePositionWithPostponed2 = updatePositionWithPostponed(updateOp.positionStart + (i * i8), updateOp.cmd);
            int i9 = updateOp.cmd;
            if (i9 == 2 ? iUpdatePositionWithPostponed2 == i5 : i9 == 4 && iUpdatePositionWithPostponed2 == i5 + 1) {
                i7++;
            } else {
                UpdateOp updateOpObtainUpdateOp = obtainUpdateOp(updateOp.cmd, i5, i7, updateOp.payload);
                dispatchFirstPassAndUpdateViewHolders(updateOpObtainUpdateOp, i6);
                recycleUpdateOp(updateOpObtainUpdateOp);
                if (updateOp.cmd == 4) {
                    i6 += i7;
                }
                i5 = iUpdatePositionWithPostponed2;
                i7 = 1;
            }
        }
        Object obj = updateOp.payload;
        recycleUpdateOp(updateOp);
        if (i7 > 0) {
            UpdateOp updateOpObtainUpdateOp2 = obtainUpdateOp(updateOp.cmd, i5, i7, obj);
