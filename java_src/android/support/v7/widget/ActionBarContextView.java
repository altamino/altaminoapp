...
public class ActionBarContextView extends AbsActionBarView {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (view2 != null) {
            ...
            this.mCustomView.measure(View.MeasureSpec.makeMeasureSpec(paddingLeft, i3), View.MeasureSpec.makeMeasureSpec(iMin, i5));
        }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (view == null || view.getVisibility() == 8) {
            ...
            iPositionChild = AbsActionBarView.next(next + positionChild(this.mClose, next, paddingTop, paddingTop2, zIsLayoutRtl), i6, zIsLayoutRtl);
        }
        LinearLayout linearLayout = this.mTitleLayout;
