...
class ViewUtilsLollipop {
    ...
    static void setDefaultAppBarLayoutStateListAnimator(View view, float f) throws Resources.NotFoundException {
        ...
        long j = integer;
        stateListAnimator.addState(new int[]{R.attr.enabled, R$attr.state_collapsible, -R$attr.state_collapsed}, ObjectAnimator.ofFloat(view, "elevation", 0.0f).setDuration(j));
