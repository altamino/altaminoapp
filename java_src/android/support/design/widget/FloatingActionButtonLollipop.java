...
class FloatingActionButtonLollipop extends FloatingActionButtonImpl {
    ...
    void setBackgroundDrawable(ColorStateList colorStateList, PorterDuff.Mode mode, int i, int i2) {
        ...
        this.mShadowViewDelegate.setBackgroundDrawable(drawable);
    }
    ...
    void onElevationsChanged(float f, float f2) {
        if (Build.VERSION.SDK_INT == 21) {
            ...
            animatorSet.setInterpolator(FloatingActionButtonImpl.ANIM_INTERPOLATOR);
            ...
            animatorSet2.setInterpolator(FloatingActionButtonImpl.ANIM_INTERPOLATOR);
            ...
            animatorSet3.setInterpolator(FloatingActionButtonImpl.ANIM_INTERPOLATOR);
            ...
            animatorSet4.setInterpolator(FloatingActionButtonImpl.ANIM_INTERPOLATOR);
