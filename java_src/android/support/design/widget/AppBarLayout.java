        ...
        public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, View view, int i, int i2, int[] iArr, int i3) {
            ...
            if (i2 != 0) {
                if (i2 < 0) {
                    ...
                    i4 = i5;
                    downNestedPreScrollRange = appBarLayout.getDownNestedPreScrollRange() + i5;
                } else {
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, int i) {
            ...
            if (i2 >= 0 && (pendingAction & 8) == 0) {
                ...
                if (this.mOffsetToChildIndexOnLayoutIsMinHeight) {
                    iRound = ViewCompat.getMinimumHeight(childAt) + appBarLayout.getTopInset();
                } else {
                    iRound = Math.round(childAt.getHeight() * this.mOffsetToChildIndexOnLayoutPerc);
                }
                setHeaderTopBottomOffset(coordinatorLayout, appBarLayout, i3 + iRound);
