...
public final class ScriptIntrinsicBLAS extends ScriptIntrinsic {
    ...
    static int validateTPMV(Element element, int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        Double.isNaN(x);
        int iSqrt = (int) Math.sqrt(x * 2.0d);
    ...
    public void DTRMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 57, i2, 0, 0, i, i3, 0, y, 0, 0.0d, id, id2, 0.0d, 0L, i4, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void ZTRMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 73, i2, 0, 0, i, i3, 0, y, 0, 0.0d, 0.0d, id, id2, 0.0d, 0.0d, 0L, i4, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void DTBMV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 58, i2, 0, 0, i, i3, 0, y, i4, 0.0d, id, id2, 0.0d, 0L, i5, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void ZTBMV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 74, i2, 0, 0, i, i3, 0, y, i4, 0.0d, 0.0d, id, id2, 0.0d, 0.0d, 0L, i5, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void DTPMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 59, i2, 0, 0, i, i3, 0, iValidateTPMV, 0, 0.0d, id, id2, 0.0d, 0L, i4, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void ZTPMV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 75, i2, 0, 0, i, i3, 0, iValidateTPMV, 0, 0.0d, 0.0d, id, id2, 0.0d, 0.0d, 0L, i4, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void DTRSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 60, i2, 0, 0, i, i3, 0, y, 0, 0.0d, id, id2, 0.0d, 0L, i4, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void ZTRSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 76, i2, 0, 0, i, i3, 0, y, 0, 0.0d, 0.0d, id, id2, 0.0d, 0.0d, 0L, i4, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void DTBSV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 61, i2, 0, 0, i, i3, 0, y, i4, 0.0d, id, id2, 0.0d, 0L, i5, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void ZTBSV(int i, int i2, int i3, int i4, Allocation allocation, Allocation allocation2, int i5) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 77, i2, 0, 0, i, i3, 0, y, i4, 0.0d, 0.0d, id, id2, 0.0d, 0.0d, 0L, i5, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void DTPSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 62, i2, 0, 0, i, i3, 0, iValidateTPMV, 0, 0.0d, id, id2, 0.0d, 0L, i4, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void ZTPSV(int i, int i2, int i3, Allocation allocation, Allocation allocation2, int i4) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 78, i2, 0, 0, i, i3, 0, iValidateTPMV, 0, 0.0d, 0.0d, id, id2, 0.0d, 0.0d, 0L, i4, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void DGER(double d, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 90, 0, 0, 0, 0, 0, y, x, 0, d, id2, id3, 0.0d, j, i, i2, 0, 0, zIsIncSupp);
    }
    ...
    public void DSYR2(int i, double d, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 93, 0, 0, 0, i, 0, 0, iValidateSYR2, 0, d, id2, id3, 0.0d, j, i2, i3, 0, 0, zIsIncSupp);
    }
    ...
    public void DSPR2(int i, double d, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 94, 0, 0, 0, i, 0, 0, iValidateSPR2, 0, d, id2, id3, 0.0d, j, i2, i3, 0, 0, zIsIncSupp);
    }
    ...
    public void ZGERU(Double2 double2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 107, 0, 0, 0, 0, 0, y, x, 0, double2.x, double2.y, id2, id3, 0.0d, 0.0d, j, i, i2, 0, 0, zIsIncSupp);
    }
    ...
    public void ZGERC(Double2 double2, Allocation allocation, int i, Allocation allocation2, int i2, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 108, 0, 0, 0, 0, 0, y, x, 0, double2.x, double2.y, id2, id3, 0.0d, 0.0d, j, i, i2, 0, 0, zIsIncSupp);
    }
    ...
    public void ZHER2(int i, Double2 double2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 111, 0, 0, 0, i, 0, 0, iValidateSYR2, 0, double2.x, double2.y, id2, id3, 0.0d, 0.0d, j, i2, i3, 0, 0, zIsIncSupp);
    }
    ...
    public void ZHPR2(int i, Double2 double2, Allocation allocation, int i2, Allocation allocation2, int i3, Allocation allocation3) {
        ...
        long j = id;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 112, 0, 0, 0, i, 0, 0, iValidateSPR2, 0, double2.x, double2.y, id2, id3, 0.0d, 0.0d, j, i2, i3, 0, 0, zIsIncSupp);
    }
    ...
    public void SGEMM(int i, int i2, float f, Allocation allocation, Allocation allocation2, float f2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 113, i, i2, 0, 0, 0, i3, i5, i4, f, j, dummyAlloc, f2, dummyAlloc2, 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void DGEMM(int i, int i2, double d, Allocation allocation, Allocation allocation2, double d2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 119, i, i2, 0, 0, 0, i3, i5, i4, d, j, dummyAlloc, d2, dummyAlloc2, 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void CGEMM(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 125, i, i2, 0, 0, 0, i3, i5, i4, float2.x, float2.y, j, dummyAlloc, float22.x, float22.y, dummyAlloc2, 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void ZGEMM(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 131, i, i2, 0, 0, 0, i3, i5, i4, double2.x, double2.y, j, dummyAlloc, double22.x, double22.y, dummyAlloc2, 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void SSYRK(int i, int i2, float f, Allocation allocation, float f2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 115, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), i3, f, id, 0L, f2, id2, 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void DSYRK(int i, int i2, double d, Allocation allocation, double d2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 121, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), i3, d, id, 0L, d2, id2, 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void CSYRK(int i, int i2, Float2 float2, Allocation allocation, Float2 float22, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 127, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), i3, float2.x, float2.y, id, 0L, float22.x, float22.y, allocation2.getID(this.mRS), 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void ZSYRK(int i, int i2, Double2 double2, Allocation allocation, Double2 double22, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 133, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), i3, double2.x, double2.y, id, 0L, double22.x, double22.y, allocation2.getID(this.mRS), 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void SSYR2K(int i, int i2, float f, Allocation allocation, Allocation allocation2, float f2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Single(getID(renderScript), 116, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i3, f, j, dummyAlloc, f2, dummyAlloc2, 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void DSYR2K(int i, int i2, double d, Allocation allocation, Allocation allocation2, double d2, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 122, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i3, d, j, dummyAlloc, d2, dummyAlloc2, 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void CSYR2K(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, Float2 float22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 128, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i3, float2.x, float2.y, j, dummyAlloc, float22.x, float22.y, dummyAlloc2, 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void ZSYR2K(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 134, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i3, double2.x, double2.y, j, dummyAlloc, double22.x, double22.y, dummyAlloc2, 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void DTRMM(int i, int i2, int i3, int i4, double d, Allocation allocation, Allocation allocation2) {
        ...
        long j = id2;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 123, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, d, id, j, 0.0d, 0L, 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void ZTRMM(int i, int i2, int i3, int i4, Double2 double2, Allocation allocation, Allocation allocation2) {
        ...
        long j = id2;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 135, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, double2.x, double2.y, id, j, 0.0d, 0.0d, 0L, 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void DTRSM(int i, int i2, int i3, int i4, double d, Allocation allocation, Allocation allocation2) {
        ...
        long j = id2;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Double(getID(renderScript), 124, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, d, id, j, 0.0d, 0L, 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void ZTRSM(int i, int i2, int i3, int i4, Double2 double2, Allocation allocation, Allocation allocation2) {
        ...
        long j = id2;
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 136, i3, 0, i, i2, i4, allocation2.getType().getY(), allocation2.getType().getX(), 0, double2.x, double2.y, id, j, 0.0d, 0.0d, 0L, 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void ZHEMM(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, Double2 double22, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), RsBlas_zhemm, 0, 0, i, i2, 0, allocation3.getType().getY(), allocation3.getType().getX(), 0, double2.x, double2.y, j, dummyAlloc, double22.x, double22.y, dummyAlloc2, 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void CHERK(int i, int i2, float f, Allocation allocation, float f2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 138, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), i3, f, 0.0f, dummyAlloc, 0L, f2, 0.0f, dummyAlloc2, 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void ZHERK(int i, int i2, double d, Allocation allocation, double d2, Allocation allocation2) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 141, i2, 0, 0, i, 0, 0, allocation2.getType().getX(), i3, d, 0.0d, dummyAlloc, 0L, d2, 0.0d, dummyAlloc2, 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void CHER2K(int i, int i2, Float2 float2, Allocation allocation, Allocation allocation2, float f, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Complex(getID(renderScript), 139, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i3, float2.x, float2.y, allocation.getID(this.mRS), dummyAlloc, f, 0.0f, dummyAlloc2, 0, 0, 0, 0, zIsIncSupp);
    }
    ...
    public void ZHER2K(int i, int i2, Double2 double2, Allocation allocation, Allocation allocation2, double d, Allocation allocation3) {
        ...
        RenderScript renderScript = this.mRS;
        renderScript.nScriptIntrinsicBLAS_Z(getID(renderScript), 142, i2, 0, 0, i, 0, 0, allocation3.getType().getX(), i3, double2.x, double2.y, allocation.getID(this.mRS), dummyAlloc, d, 0.0d, dummyAlloc2, 0, 0, 0, 0, zIsIncSupp);
    }
