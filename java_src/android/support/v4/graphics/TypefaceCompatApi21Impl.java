    ...
    public Typeface createFromFontInfo(Context context, CancellationSignal cancellationSignal, FontsContractCompat.FontInfo[] fontInfoArr, int i) throws IOException {
        ...
        try {
            ...
            try {
                ...
                try {
                    Typeface typefaceCreateFromInputStream = super.createFromInputStream(context, new FileInputStream(parcelFileDescriptorOpenFileDescriptor.getFileDescriptor()));
                    if (parcelFileDescriptorOpenFileDescriptor != null) {
                        parcelFileDescriptorOpenFileDescriptor.close();
                    }
