...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    */
    void moveToState(android.support.v4.app.Fragment r18, int r19, int r20, int r21, boolean r22) throws android.content.res.Resources.NotFoundException {
        /*
    ...
    void restoreAllState(Parcelable parcelable, FragmentManagerNonConfig fragmentManagerNonConfig) {
        ...
        if (backStackStateArr != null) {
            ...
            while (true) {
                ...
                BackStackRecord backStackRecordInstantiate = backStackStateArr2[i7].instantiate(this);
                if (DEBUG) {
                    Log.v(TAG, "restoreAllState: back stack #" + i7 + " (index " + backStackRecordInstantiate.mIndex + "): " + backStackRecordInstantiate);
                    PrintWriter printWriter = new PrintWriter(new LogWriter(TAG));
