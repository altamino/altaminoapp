...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public void connect(OkHttpClient okHttpClient) {
        ...
        final Request requestBuild = this.originalRequest.newBuilder().header("Upgrade", WsService.TAG).header("Connection", "Upgrade").header("Sec-WebSocket-Key", this.key).header("Sec-WebSocket-Version", "13").build();
    ...
    void checkResponse(Response response) throws ProtocolException {
        ...
        if (!WsService.TAG.equalsIgnoreCase(strHeader2)) {
