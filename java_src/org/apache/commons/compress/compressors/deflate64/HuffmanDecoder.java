...
class HuffmanDecoder implements Closeable {
    ...
    static {
        Arrays.fill(FIXED_LITERALS, 0, IjkMediaMeta.FF_PROFILE_H264_HIGH_444, 8);
        Arrays.fill(FIXED_LITERALS, IjkMediaMeta.FF_PROFILE_H264_HIGH_444, 256, 9);
