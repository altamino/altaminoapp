...
public class FormElement extends Element {
    ...
    public Connection submit() {
        ...
        return Jsoup.connect(strAbsUrl).data(formData()).method(attr("method").toUpperCase().equals(GlobalSearchResultSection.SECTION_TYPE_POST) ? Connection.Method.POST : Connection.Method.GET);
    }
