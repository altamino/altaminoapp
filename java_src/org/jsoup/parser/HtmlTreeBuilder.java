...
public class HtmlTreeBuilder extends TreeBuilder {
    ...
    List<Node> parseFragment(String str, Element element, String str2, ParseErrorList parseErrorList, ParseSettings parseSettings) {
        ...
        if (element != null) {
            ...
            } else if (StringUtil.in(strTagName, "iframe", "noembed", "noframes", TtmlNode.TAG_STYLE, "xmp")) {
    ...
    void insert(Token.Character character) {
        ...
        } else if (strTagName.equals("script") || strTagName.equals(TtmlNode.TAG_STYLE)) {
    ...
    void reconstructFormattingElements() {
        ...
        boolean z = true;
        int size = this.formattingElements.size() - 1;
        Element element = elementLastFormattingElement;
        int i = size;
        while (i != 0) {
            i--;
        ...
        while (true) {
            ...
            Element elementInsertStartTag = insertStartTag(element.nodeName());
            elementInsertStartTag.attributes().addAll(element.attributes());
