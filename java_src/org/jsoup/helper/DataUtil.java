...
public final class DataUtil {
    ...
    static Document parseInputStream(InputStream inputStream, String str, String str2, Parser parser) throws IOException {
        ...
        if (str == null) {
            ...
            while (it.hasNext()) {
                ...
                if (next.hasAttr("http-equiv")) {
                    strAttr = getCharsetFromContentType(next.attr("content"));
                }
        ...
        if (input == null) {
            ...
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(constrainableInputStreamWrap, str), 32768);
            ...
            try {
                ...
                input.outputSettings().charset(str);
